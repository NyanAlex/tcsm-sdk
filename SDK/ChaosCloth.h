...
public:
	...
	void SetVelocityScale(FVector LinearVelocityScale, float AngularVelocityScale, float FictitiousAngularScale) // [0x19ee250] Final|Native|Public|HasDefaults|BlueprintCallable 
	{
	...
	void SetMaterialLinear(float EdgeStiffness, float BendingStiffness, float AreaStiffness) // [0x19ee130] Final|Native|Public|BlueprintCallable 
	{
	...
	void SetLongRangeAttachmentLinear(float TetherStiffness) // [0x19ee0b0] Final|Native|Public|BlueprintCallable 
	{
	...
	void SetLongRangeAttachment(FVector2D TetherStiffness) // [0x19ee030] Final|Native|Public|HasDefaults|BlueprintCallable 
	{
	...
	void SetGravity(float GravityScale, bool bIsGravityOverridden, FVector GravityOverride) // [0x19edf00] Final|Native|Public|HasDefaults|BlueprintCallable 
	{
	...
	void SetDamping(float DampingCoefficient) // [0x19ede80] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(float);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void SetCollision(float CollisionThickness, float FrictionCoefficient, bool bUseCCD, float SelfCollisionThickness) // [0x19edd10] Final|Native|Public|BlueprintCallable 
	{
	...
	void SetAnimDriveLinear(float AnimDriveStiffness) // [0x19edc90] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(float);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void SetAnimDrive(FVector2D AnimDriveStiffness, FVector2D AnimDriveDamping) // [0x19edbd0] Final|Native|Public|HasDefaults|BlueprintCallable 
	{
	...
	void SetAerodynamics(float DragCoefficient, float LiftCoefficient, FVector WindVelocity) // [0x19edab0] Final|Native|Public|HasDefaults|BlueprintCallable 
	{
	...
	void ResetAndTeleport(bool bReset, bool bTeleport) // [0x19ed9e0] Final|Native|Public|BlueprintCallable 
	{
