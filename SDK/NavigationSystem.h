...
public:
	...
	class UPrimitiveComponent*                         RenderingComp;                                              // 0x0230   (0x0008)  
	FNavDataConfig                                     NavDataConfig;                                              // 0x0238   (0x0078)  
	bool                                               bEnableDrawing : 1;                                         // 0x02B0:0 (0x0001)  
	bool                                               bForceRebuildOnLoad : 1;                                    // 0x02B0:1 (0x0001)  
	bool                                               bAutoDestroyWhenNoNavigation : 1;                           // 0x02B0:2 (0x0001)  
	bool                                               bCanBeMainNavData : 1;                                      // 0x02B0:3 (0x0001)  
	bool                                               bCanSpawnOnRebuild : 1;                                     // 0x02B0:4 (0x0001)  
	bool                                               bRebuildAtRuntime : 1;                                      // 0x02B0:5 (0x0001)  
	...
	unsigned char                                      UnknownData03_6[0x108];                                     // 0x02C0   (0x0108)  MISSED
	TArray<FSupportedAreaData>                         SupportedAreas;                                             // 0x03C8   (0x0010)  
	unsigned char                                      UnknownData04_7[0x58];                                      // 0x03D8   (0x0058)  MISSED
};
...
{ 
public:
	SDK_UNDEFINED(16,264) /* FMulticastInlineDelegate */ __um(PathUpdatedNotifier);                                // 0x0028   (0x0010)  
	...
	bool IsValid() // [0x42509b0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	bool IsStringPulled() // [0x1e02100] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef bool (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	bool IsPartial() // [0x4250980] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef bool (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	float GetPathLength() // [0x4250240] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	float GetPathCost() // [0x424ffe0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef float (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	FString GetDebugString() // [0x424fed0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	// void EnableRecalculationOnInvalidation(TEnumAsByte<ENavigationOptionFlag> DoRecalculation);                              // [0x424fa70] Final|Native|Public|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationPath.EnableDebugDrawing
	void EnableDebugDrawing(bool bShouldDrawDebugData, FLinearColor PathColor) // [0x424f990] Final|Native|Public|HasDefaults|BlueprintCallable 
	{
...
public:
	...
	SDK_UNDEFINED(16,265) /* FMulticastInlineDelegate */ __um(OnNavDataRegisteredEvent);                           // 0x00C0   (0x0010)  
	SDK_UNDEFINED(16,266) /* FMulticastInlineDelegate */ __um(OnNavigationGenerationFinishedDelegate);             // 0x00D0   (0x0010)  
	...
	void UnregisterNavigationInvoker(AActor* Invoker) // [0x42518e0] Final|Native|Public|BlueprintCallable 
	{
	...
	void SimpleMoveToLocation(AController* Controller, FVector& Goal) // [0x4251820] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
	...
	void SimpleMoveToActor(AController* Controller, AActor* Goal) // [0x413ab60] Final|Native|Static|Public|BlueprintCallable 
	{
	...
	void SetMaxSimultaneousTileGenerationJobsCount(int32_t MaxNumberOfJobs) // [0x4251790] Final|Native|Public|BlueprintCallable 
	{
	...
	void SetGeometryGatheringMode(ENavDataGatheringModeConfig NewMode) // [0x4251710] Final|Native|Public|BlueprintCallable 
	{
	...
	void ResetMaxSimultaneousTileGenerationJobsCount() // [0x42516f0] Final|Native|Public|BlueprintCallable 
	{
	...
	void RegisterNavigationInvoker(AActor* Invoker, float TileGenerationRadius, float TileRemovalRadius) // [0x42515e0] Final|Native|Public|BlueprintCallable 
	{
	...
	FVector ProjectPointToNavigation(UObject* WorldContextObject, FVector& Point, ANavigationData* NavData, UClass* FilterClass, FVector QueryExtent) // [0x42513f0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	{
	...
	void OnNavigationBoundsUpdated(ANavMeshBoundsVolume* NavVolume) // [0x4251360] Final|Native|Public|BlueprintCallable 
	{
	...
	bool NavigationRaycast(UObject* WorldContextObject, FVector& RayStart, FVector& RayEnd, FVector& HitLocation, UClass* FilterClass, AController* Querier) // [0x4251130] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
	...
	bool K2_ReplaceAreaInOctreeData(UObject* Object, UClass* OldArea, UClass* NewArea) // [0x4251020] Final|Native|Public|BlueprintCallable 
	{
	...
	bool K2_ProjectPointToNavigation(UObject* WorldContextObject, FVector& Point, FVector& ProjectedLocation, ANavigationData* NavData, UClass* FilterClass, FVector QueryExtent) // [0x4250e20] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	{
	...
	bool K2_GetRandomReachablePointInRadius(UObject* WorldContextObject, FVector& Origin, FVector& RandomLocation, float Radius, ANavigationData* NavData, UClass* FilterClass) // [0x4250c00] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	{
	...
	bool K2_GetRandomPointInNavigableRadius(UObject* WorldContextObject, FVector& Origin, FVector& RandomLocation, float Radius, ANavigationData* NavData, UClass* FilterClass) // [0x42509e0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	{
		typedef bool (*FuncPtr)(UObject*, FVector&, FVector&, float, ANavigationData*, UClass*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	bool K2_GetRandomLocationInNavigableRadius(UObject* WorldContextObject, FVector& Origin, FVector& RandomLocation, float Radius, ANavigationData* NavData, UClass* FilterClass) // [0x42509e0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
		typedef bool (*FuncPtr)(UObject*, FVector&, FVector&, float, ANavigationData*, UClass*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	bool IsNavigationBeingBuiltOrLocked(UObject* WorldContextObject) // [0x42508f0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	{
	...
	bool IsNavigationBeingBuilt(UObject* WorldContextObject) // [0x4250860] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	{
		typedef bool (*FuncPtr)(UObject*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	FVector GetRandomReachablePointInRadius(UObject* WorldContextObject, FVector& Origin, float Radius, ANavigationData* NavData, UClass* FilterClass) // [0x4250680] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	{
	...
	FVector GetRandomPointInNavigableRadius(UObject* WorldContextObject, FVector& Origin, float Radius, ANavigationData* NavData, UClass* FilterClass) // [0x42504a0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	{
		typedef FVector (*FuncPtr)(UObject*, FVector&, float, ANavigationData*, UClass*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	// TEnumAsByte<ENavigationQueryResult> GetPathLength(UObject* WorldContextObject, FVector& PathStart, FVector& PathEnd, float& PathLength, ANavigationData* NavData, UClass* FilterClass); // [0x4250270] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.GetPathCost
	// TEnumAsByte<ENavigationQueryResult> GetPathCost(UObject* WorldContextObject, FVector& PathStart, FVector& PathEnd, float& PathCost, ANavigationData* NavData, UClass* FilterClass); // [0x4250010] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.GetNavigationSystem
	UNavigationSystemV1* GetNavigationSystem(UObject* WorldContextObject) // [0x424ff50] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	{
	...
	UNavigationPath* FindPathToLocationSynchronously(UObject* WorldContextObject, FVector& PathStart, FVector& PathEnd, AActor* PathfindingContext, UClass* FilterClass) // [0x424fd00] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
	...
	UNavigationPath* FindPathToActorSynchronously(UObject* WorldContextObject, FVector& PathStart, AActor* GoalActor, float TetherDistance, AActor* PathfindingContext, UClass* FilterClass) // [0x424faf0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
...
/// Size: 0x0318 (792 bytes) (0x000228 - 0x000318) align 8 MaxSize: 0x0318
class ANavigationTestingActor : public AActor
{ 
public:
	unsigned char                                      UnknownData00_8[0x10];                                      // 0x0228   (0x0010)  MISSED
	class UCapsuleComponent*                           CapsuleComponent;                                           // 0x0238   (0x0008)  
	class UNavigationInvokerComponent*                 InvokerComponent;                                           // 0x0240   (0x0008)  
	bool                                               bActAsNavigationInvoker : 1;                                // 0x0248:0 (0x0001)  
	...
	class ANavigationData*                             MyNavData;                                                  // 0x0290   (0x0008)  
	FVector                                            ProjectedLocation;                                          // 0x0298   (0x000C)  
	bool                                               bProjectedLocationValid : 1;                                // 0x02A4:0 (0x0001)  
	bool                                               bSearchStart : 1;                                           // 0x02A4:1 (0x0001)  
	unsigned char                                      UnknownData03_5[0x3];                                       // 0x02A5   (0x0003)  MISSED
	float                                              CostLimitFactor;                                            // 0x02A8   (0x0004)  
	float                                              MinimumCostLimit;                                           // 0x02AC   (0x0004)  
	bool                                               bBacktracking : 1;                                          // 0x02B0:0 (0x0001)  
	bool                                               bUseHierarchicalPathfinding : 1;                            // 0x02B0:1 (0x0001)  
	bool                                               bGatherDetailedInfo : 1;                                    // 0x02B0:2 (0x0001)  
	bool                                               bDrawDistanceToWall : 1;                                    // 0x02B0:3 (0x0001)  
	bool                                               bShowNodePool : 1;                                          // 0x02B0:4 (0x0001)  
	bool                                               bShowBestPath : 1;                                          // 0x02B0:5 (0x0001)  
	bool                                               bShowDiffWithPreviousStep : 1;                              // 0x02B0:6 (0x0001)  
	bool                                               bShouldBeVisibleInGame : 1;                                 // 0x02B0:7 (0x0001)  
	...
	bool                                               bPathExist : 1;                                             // 0x02C0:0 (0x0001)  
	bool                                               bPathIsPartial : 1;                                         // 0x02C0:1 (0x0001)  
	bool                                               bPathSearchOutOfNodes : 1;                                  // 0x02C0:2 (0x0001)  
	unsigned char                                      UnknownData06_5[0x3];                                       // 0x02C1   (0x0003)  MISSED
	float                                              PathfindingTime;                                            // 0x02C4   (0x0004)  
	float                                              PathCost;                                                   // 0x02C8   (0x0004)  
	int32_t                                            PathfindingSteps;                                           // 0x02CC   (0x0004)  
	class ANavigationTestingActor*                     OtherActor;                                                 // 0x02D0   (0x0008)  
	class UClass*                                      FilterClass;                                                // 0x02D8   (0x0008)  
	int32_t                                            ShowStepIndex;                                              // 0x02E0   (0x0004)  
	float                                              OffsetFromCornersDistance;                                  // 0x02E4   (0x0004)  
	unsigned char                                      UnknownData07_7[0x30];                                      // 0x02E8   (0x0030)  MISSED
};
...
public:
	...
	TArray<FNavigationLink>                            Links;                                                      // 0x0468   (0x0010)  
	unsigned char                                      UnknownData01_7[0x8];                                       // 0x0478   (0x0008)  MISSED
};
...
public:
	...
	void SetNavigationRelevancy(bool bRelevant) // [0x4253920] Final|Native|Public|BlueprintCallable 
	{
...
/// Size: 0x0470 (1136 bytes) (0x000460 - 0x000470) align 16 MaxSize: 0x0470
...
public:
	...
	void SetAreaClass(UClass* NewAreaClass) // [0x4253890] Final|Native|Public|BlueprintCallable 
	{
...
public:
	...
	class UClass*                                      AreaClass;                                                  // 0x0268   (0x0008)  
	bool                                               bMaskFillCollisionUnderneathForNavmesh;                     // 0x0270   (0x0001)  
	unsigned char                                      UnknownData01_7[0x7];                                       // 0x0271   (0x0007)  MISSED


	/// Functions
	// Function /Script/NavigationSystem.NavModifierVolume.SetAreaClass
	void SetAreaClass(UClass* NewAreaClass) // [0x4253800] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(UClass*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
...
{ 
public:
	class UNavigationSystemConfig*                     NavigationSystemConfig;                                     // 0x0228   (0x0008)  
	ENavSystemOverridePolicy                           OverridePolicy;                                             // 0x0230   (0x0001)  
	bool                                               bLoadOnClient : 1;                                          // 0x0231:0 (0x0001)  
	unsigned char                                      UnknownData00_7[0x6];                                       // 0x0232   (0x0006)  MISSED
};
...
/// Size: 0x04E0 (1248 bytes) (0x000430 - 0x0004E0) align 8 MaxSize: 0x04E0
class ARecastNavMesh : public ANavigationData
{ 
public:
	bool                                               bDrawTriangleEdges : 1;                                     // 0x0430:0 (0x0001)  
	bool                                               bDrawPolyEdges : 1;                                         // 0x0430:1 (0x0001)  
	bool                                               bDrawFilledPolys : 1;                                       // 0x0430:2 (0x0001)  
	bool                                               bDrawNavMeshEdges : 1;                                      // 0x0430:3 (0x0001)  
	bool                                               bDrawTileBounds : 1;                                        // 0x0430:4 (0x0001)  
	bool                                               bDrawPathCollidingGeometry : 1;                             // 0x0430:5 (0x0001)  
	bool                                               bDrawTileLabels : 1;                                        // 0x0430:6 (0x0001)  
	bool                                               bDrawPolygonLabels : 1;                                     // 0x0430:7 (0x0001)  
	bool                                               bDrawDefaultPolygonCost : 1;                                // 0x0431:0 (0x0001)  
	bool                                               bDrawPolygonFlags : 1;                                      // 0x0431:1 (0x0001)  
	bool                                               bDrawLabelsOnPathNodes : 1;                                 // 0x0431:2 (0x0001)  
	bool                                               bDrawNavLinks : 1;                                          // 0x0431:3 (0x0001)  
	bool                                               bDrawFailedNavLinks : 1;                                    // 0x0431:4 (0x0001)  
	bool                                               bDrawClusters : 1;                                          // 0x0431:5 (0x0001)  
	bool                                               bDrawOctree : 1;                                            // 0x0431:6 (0x0001)  
	bool                                               bDrawOctreeDetails : 1;                                     // 0x0431:7 (0x0001)  
	bool                                               bDrawMarkedForbiddenPolys : 1;                              // 0x0432:0 (0x0001)  
	bool                                               bDistinctlyDrawTilesBeingBuilt : 1;                         // 0x0432:1 (0x0001)  
	unsigned char                                      UnknownData00_5[0x1];                                       // 0x0433   (0x0001)  MISSED
	float                                              DrawOffset;                                                 // 0x0434   (0x0004)  
	bool                                               bFixedTilePoolSize : 1;                                     // 0x0438:0 (0x0001)  
	unsigned char                                      UnknownData01_5[0x3];                                       // 0x0439   (0x0003)  MISSED
	int32_t                                            TilePoolSize;                                               // 0x043C   (0x0004)  
	float                                              TileSizeUU;                                                 // 0x0440   (0x0004)  
	float                                              CellSize;                                                   // 0x0444   (0x0004)  
	float                                              CellHeight;                                                 // 0x0448   (0x0004)  
	float                                              AgentRadius;                                                // 0x044C   (0x0004)  
	float                                              AgentHeight;                                                // 0x0450   (0x0004)  
	float                                              AgentMaxSlope;                                              // 0x0454   (0x0004)  
	float                                              AgentMaxStepHeight;                                         // 0x0458   (0x0004)  
	float                                              MinRegionArea;                                              // 0x045C   (0x0004)  
	float                                              MergeRegionSize;                                            // 0x0460   (0x0004)  
	float                                              MaxSimplificationError;                                     // 0x0464   (0x0004)  
	int32_t                                            MaxSimultaneousTileGenerationJobsCount;                     // 0x0468   (0x0004)  
	int32_t                                            TileNumberHardLimit;                                        // 0x046C   (0x0004)  
	int32_t                                            PolyRefTileBits;                                            // 0x0470   (0x0004)  
	int32_t                                            PolyRefNavPolyBits;                                         // 0x0474   (0x0004)  
	int32_t                                            PolyRefSaltBits;                                            // 0x0478   (0x0004)  
	FVector                                            NavMeshOriginOffset;                                        // 0x047C   (0x000C)  
	float                                              DefaultDrawDistance;                                        // 0x0488   (0x0004)  
	float                                              DefaultMaxSearchNodes;                                      // 0x048C   (0x0004)  
	float                                              DefaultMaxHierarchicalSearchNodes;                          // 0x0490   (0x0004)  
	TEnumAsByte<ERecastPartitioning>                   RegionPartitioning;                                         // 0x0494   (0x0001)  
	TEnumAsByte<ERecastPartitioning>                   LayerPartitioning;                                          // 0x0495   (0x0001)  
	unsigned char                                      UnknownData02_6[0x2];                                       // 0x0496   (0x0002)  MISSED
	int32_t                                            RegionChunkSplits;                                          // 0x0498   (0x0004)  
	int32_t                                            LayerChunkSplits;                                           // 0x049C   (0x0004)  
	bool                                               bSortNavigationAreasByCost : 1;                             // 0x04A0:0 (0x0001)  
	bool                                               bPerformVoxelFiltering : 1;                                 // 0x04A0:1 (0x0001)  
	bool                                               bMarkLowHeightAreas : 1;                                    // 0x04A0:2 (0x0001)  
	bool                                               bUseExtraTopCellWhenMarkingAreas : 1;                       // 0x04A0:3 (0x0001)  
	bool                                               bFilterLowSpanSequences : 1;                                // 0x04A0:4 (0x0001)  
	bool                                               bFilterLowSpanFromTileCache : 1;                            // 0x04A0:5 (0x0001)  
	bool                                               bDoFullyAsyncNavDataGathering : 1;                          // 0x04A0:6 (0x0001)  
	bool                                               bUseBetterOffsetsFromCorners : 1;                           // 0x04A0:7 (0x0001)  
	bool                                               bStoreEmptyTileLayers : 1;                                  // 0x04A1:0 (0x0001)  
	bool                                               bUseVirtualFilters : 1;                                     // 0x04A1:1 (0x0001)  
	bool                                               bAllowNavLinkAsPathEnd : 1;                                 // 0x04A1:2 (0x0001)  
	bool                                               bUseVoxelCache : 1;                                         // 0x04A1:3 (0x0001)  
	unsigned char                                      UnknownData03_5[0x2];                                       // 0x04A2   (0x0002)  MISSED
	float                                              TileSetUpdateInterval;                                      // 0x04A4   (0x0004)  
	float                                              HeuristicScale;                                             // 0x04A8   (0x0004)  
	float                                              VerticalDeviationFromGroundCompensation;                    // 0x04AC   (0x0004)  
	unsigned char                                      UnknownData04_7[0x30];                                      // 0x04B0   (0x0030)  MISSED


	/// Functions
	// Function /Script/NavigationSystem.RecastNavMesh.K2_ReplaceAreaInTileBounds
	bool K2_ReplaceAreaInTileBounds(FBox Bounds, UClass* OldArea, UClass* NewArea, bool ReplaceLinks) // [0x4253660] Final|Native|Public|HasDefaults|BlueprintCallable 
	{
...
static_assert(sizeof(ANavigationData) == 0x0430); // 1072 bytes (0x000228 - 0x000430)
static_assert(sizeof(AAbstractNavData) == 0x0430); // 1072 bytes (0x000430 - 0x000430)
...
static_assert(sizeof(ANavigationGraph) == 0x0430); // 1072 bytes (0x000430 - 0x000430)
static_assert(sizeof(ANavigationGraphNode) == 0x0228); // 552 bytes (0x000228 - 0x000228)
...
static_assert(sizeof(ANavigationTestingActor) == 0x0318); // 792 bytes (0x000228 - 0x000318)
static_assert(sizeof(UNavLinkComponent) == 0x0480); // 1152 bytes (0x000460 - 0x000480)
...
static_assert(sizeof(UNavLinkRenderingComponent) == 0x0460); // 1120 bytes (0x000460 - 0x000460)
static_assert(sizeof(UNavLinkTrivial) == 0x0050); // 80 bytes (0x000050 - 0x000050)
static_assert(sizeof(ANavMeshBoundsVolume) == 0x0268); // 616 bytes (0x000260 - 0x000268)
static_assert(sizeof(UNavMeshRenderingComponent) == 0x0470); // 1136 bytes (0x000460 - 0x000470)
static_assert(sizeof(UNavModifierComponent) == 0x0140); // 320 bytes (0x0000E0 - 0x000140)
static_assert(sizeof(ANavModifierVolume) == 0x0278); // 632 bytes (0x000260 - 0x000278)
static_assert(sizeof(UNavNodeInterface) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(ANavSystemConfigOverride) == 0x0238); // 568 bytes (0x000228 - 0x000238)
static_assert(sizeof(UNavTestRenderingComponent) == 0x0460); // 1120 bytes (0x000460 - 0x000460)
static_assert(sizeof(URecastFilter_UseDefaultArea) == 0x0048); // 72 bytes (0x000048 - 0x000048)
static_assert(sizeof(ARecastNavMesh) == 0x04E0); // 1248 bytes (0x000430 - 0x0004E0)
...
static_assert(offsetof(ANavigationData, RenderingComp) == 0x0230);
static_assert(offsetof(ANavigationData, NavDataConfig) == 0x0238);
static_assert(offsetof(ANavigationData, RuntimeGeneration) == 0x02B4);
static_assert(offsetof(ANavigationData, SupportedAreas) == 0x03C8);
...
static_assert(offsetof(ANavigationTestingActor, CapsuleComponent) == 0x0238);
static_assert(offsetof(ANavigationTestingActor, InvokerComponent) == 0x0240);
static_assert(offsetof(ANavigationTestingActor, NavAgentProps) == 0x0250);
static_assert(offsetof(ANavigationTestingActor, QueryingExtent) == 0x0280);
static_assert(offsetof(ANavigationTestingActor, MyNavData) == 0x0290);
static_assert(offsetof(ANavigationTestingActor, ProjectedLocation) == 0x0298);
static_assert(offsetof(ANavigationTestingActor, CostDisplayMode) == 0x02B4);
static_assert(offsetof(ANavigationTestingActor, TextCanvasOffset) == 0x02B8);
static_assert(offsetof(ANavigationTestingActor, OtherActor) == 0x02D0);
static_assert(offsetof(ANavigationTestingActor, FilterClass) == 0x02D8);
static_assert(offsetof(UNavLinkComponent, Links) == 0x0468);
...
static_assert(offsetof(ANavMeshBoundsVolume, SupportedAgents) == 0x0260);
...
static_assert(offsetof(ANavModifierVolume, AreaClass) == 0x0268);
static_assert(offsetof(ANavSystemConfigOverride, NavigationSystemConfig) == 0x0228);
static_assert(offsetof(ANavSystemConfigOverride, OverridePolicy) == 0x0230);
static_assert(offsetof(ARecastNavMesh, NavMeshOriginOffset) == 0x047C);
static_assert(offsetof(ARecastNavMesh, RegionPartitioning) == 0x0494);
static_assert(offsetof(ARecastNavMesh, LayerPartitioning) == 0x0495);
