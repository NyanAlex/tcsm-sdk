...
{ 
public:
	class UControlPointMeshComponent*                  ControlPointMeshComponent;                                  // 0x0228   (0x0008)  
};
...
{ 
public:
	float                                              VirtualTextureMainPassMaxDrawDistance;                      // 0x04F8   (0x0004)  
	unsigned char                                      UnknownData00_7[0x4];                                       // 0x04FC   (0x0004)  MISSED
};

/// Class /Script/Landscape.LandscapeProxy
/// Size: 0x05A0 (1440 bytes) (0x000228 - 0x0005A0) align 8 MaxSize: 0x05A0
class ALandscapeProxy : public AActor
{ 
public:
	class ULandscapeSplinesComponent*                  SplineComponent;                                            // 0x0228   (0x0008)  
	...
	class UPhysicalMaterial*                           DefaultPhysMaterial;                                        // 0x0278   (0x0008)  
	float                                              StreamingDistanceMultiplier;                                // 0x0280   (0x0004)  
	unsigned char                                      UnknownData02_6[0x4];                                       // 0x0284   (0x0004)  MISSED
	class UMaterialInterface*                          LandscapeMaterial;                                          // 0x0288   (0x0008)  
	unsigned char                                      UnknownData03_6[0x20];                                      // 0x0290   (0x0020)  MISSED
	class UMaterialInterface*                          LandscapeHoleMaterial;                                      // 0x02B0   (0x0008)  
	...
	unsigned char                                      UnknownData04_6[0x6];                                       // 0x02CA   (0x0006)  MISSED
	TArray<class URuntimeVirtualTexture*>              RuntimeVirtualTextures;                                     // 0x02D0   (0x0010)  
	...
	unsigned char                                      UnknownData05_6[0x3];                                       // 0x02E9   (0x0003)  MISSED
	float                                              NegativeZBoundsExtension;                                   // 0x02EC   (0x0004)  
	float                                              PositiveZBoundsExtension;                                   // 0x02F0   (0x0004)  
	unsigned char                                      UnknownData06_6[0x4];                                       // 0x02F4   (0x0004)  MISSED
	TArray<class ULandscapeComponent*>                 LandscapeComponents;                                        // 0x02F8   (0x0010)  
	TArray<class ULandscapeHeightfieldCollisionComponent*> CollisionComponents;                                    // 0x0308   (0x0010)  
	TArray<class UHierarchicalInstancedStaticMeshComponent*> FoliageComponents;                                    // 0x0318   (0x0010)  
	unsigned char                                      UnknownData07_6[0x64];                                      // 0x0328   (0x0064)  MISSED
	bool                                               bHasLandscapeGrass;                                         // 0x038C   (0x0001)  
	unsigned char                                      UnknownData08_6[0x3];                                       // 0x038D   (0x0003)  MISSED
	float                                              StaticLightingResolution;                                   // 0x0390   (0x0004)  
	bool                                               CastShadow : 1;                                             // 0x0394:0 (0x0001)  
	bool                                               bCastDynamicShadow : 1;                                     // 0x0394:1 (0x0001)  
	bool                                               bCastStaticShadow : 1;                                      // 0x0394:2 (0x0001)  
	unsigned char                                      UnknownData09_3[0x3];                                       // 0x0395   (0x0003)  MISSED
	bool                                               bCastFarShadow : 1;                                         // 0x0398:0 (0x0001)  
	unsigned char                                      UnknownData10_3[0x3];                                       // 0x0399   (0x0003)  MISSED
	bool                                               bCastHiddenShadow : 1;                                      // 0x039C:0 (0x0001)  
	unsigned char                                      UnknownData11_3[0x3];                                       // 0x039D   (0x0003)  MISSED
	bool                                               bCastShadowAsTwoSided : 1;                                  // 0x03A0:0 (0x0001)  
	unsigned char                                      UnknownData12_3[0x3];                                       // 0x03A1   (0x0003)  MISSED
	bool                                               bAffectDistanceFieldLighting : 1;                           // 0x03A4:0 (0x0001)  
	FLightingChannels                                  LightingChannels;                                           // 0x03A5   (0x0001)  
	unsigned char                                      UnknownData13_6[0x2];                                       // 0x03A6   (0x0002)  MISSED
	bool                                               bUseMaterialPositionOffsetInStaticLighting : 1;             // 0x03A8:0 (0x0001)  
	bool                                               bRenderCustomDepth : 1;                                     // 0x03A8:1 (0x0001)  
	unsigned char                                      UnknownData14_5[0x3];                                       // 0x03A9   (0x0003)  MISSED
	ERendererStencilMask                               CustomDepthStencilWriteMask;                                // 0x03AC   (0x0001)  
	unsigned char                                      UnknownData15_6[0x3];                                       // 0x03AD   (0x0003)  MISSED
	...
	unsigned char                                      UnknownData16_6[0x4];                                       // 0x03DC   (0x0004)  MISSED
	FBodyInstance                                      BodyInstance;                                               // 0x03E0   (0x0158)  
	bool                                               bGenerateOverlapEvents : 1;                                 // 0x0538:0 (0x0001)  
	bool                                               bBakeMaterialPositionOffsetIntoCollision : 1;               // 0x0538:1 (0x0001)  
	unsigned char                                      UnknownData17_5[0x3];                                       // 0x0539   (0x0003)  MISSED
	int32_t                                            ComponentSizeQuads;                                         // 0x053C   (0x0004)  
	int32_t                                            SubsectionSizeQuads;                                        // 0x0540   (0x0004)  
	int32_t                                            NumSubsections;                                             // 0x0544   (0x0004)  
	bool                                               bUsedForNavigation : 1;                                     // 0x0548:0 (0x0001)  
	bool                                               bFillCollisionUnderLandscapeForNavmesh : 1;                 // 0x0548:1 (0x0001)  
	unsigned char                                      UnknownData18_5[0x3];                                       // 0x0549   (0x0003)  MISSED
	...
	TMap<class UTexture2D*, class ULandscapeWeightmapUsage*> WeightmapUsageMap;                                    // 0x0550   (0x0050)  


	/// Functions
	// Function /Script/Landscape.LandscapeProxy.SetLandscapeMaterialVectorParameterValue
	void SetLandscapeMaterialVectorParameterValue(FName ParameterName, FLinearColor Value) // [0x343ead0] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	{
	...
	void SetLandscapeMaterialTextureParameterValue(FName ParameterName, UTexture* Value) // [0x343ea00] Final|RequiredAPI|Native|Public|BlueprintCallable 
	{
	...
	void SetLandscapeMaterialScalarParameterValue(FName ParameterName, float Value) // [0x343e930] Final|RequiredAPI|Native|Public|BlueprintCallable 
	{
	...
	bool LandscapeExportHeightmapToRenderTarget(UTextureRenderTarget2D* InRenderTarget, bool InExportHeightIntoRGChannel, bool InExportLandscapeProxies) // [0x343e810] Final|Native|Public|BlueprintCallable 
	{
	...
	void EditorSetLandscapeMaterial(UMaterialInterface* NewLandscapeMaterial) // [0x19a6a50] Final|Native|Public|BlueprintCallable 
	{
	...
	void EditorApplySpline(USplineComponent* InSplineComponent, float StartWidth, float EndWidth, float StartSideFalloff, float EndSideFalloff, float StartRoll, float EndRoll, int32_t NumSubdivisions, bool bRaiseHeights, bool bLowerHeights, ULandscapeLayerInfoObject* PaintLayer, FName EditLayerName) // [0x343e480] Final|RequiredAPI|Native|Public|BlueprintCallable 
	{
	...
	void ChangeUseTessellationComponentScreenSizeFalloff(bool InComponentScreenSizeToUseSubSections) // [0x1e0b0b0] Native|Public|BlueprintCallable 
	{
	...
	void ChangeTessellationComponentScreenSizeFalloff(float InUseTessellationComponentScreenSizeFalloff) // [0x343e3f0] Native|Public|BlueprintCallable 
	{
	...
	void ChangeTessellationComponentScreenSize(float InTessellationComponentScreenSize) // [0x343e360] Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(float);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void ChangeLODDistanceFactor(float InLODDistanceFactor) // [0x343e2d0] Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(float);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void ChangeComponentScreenSizeToUseSubSections(float InComponentScreenSizeToUseSubSections) // [0x343e240] Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(float);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
...
public:
	...
	void RequestLandscapeUpdate() // [0xb888e0] Final|Native|Public|BlueprintCallable 
	{
	...
	UTextureRenderTarget2D* Render(bool InIsHeightmap, UTextureRenderTarget2D* InCombinedResult, FName& InWeightmapLayerName) // [0x343cb60] Native|Event|Public|HasOutParms|BlueprintEvent 
	{
	...
	void Initialize(FTransform& InLandscapeTransform, FIntPoint& InLandscapeSize, FIntPoint& InLandscapeRenderTargetSize) // [0x343c9e0] Native|Event|Public|HasOutParms|HasDefaults|BlueprintEvent 
	{
	...
	// void GetBlueprintRenderDependencies(TArray<UObject*>& OutStreamableAssets);                                              // [0x2438a30] Event|Public|HasOutParms|BlueprintEvent 
};
...
/// Size: 0x0680 (1664 bytes) (0x000460 - 0x000680) align 16 MaxSize: 0x0680
class ULandscapeComponent : public UPrimitiveComponent
{ 
public:
	int32_t                                            SectionBaseX;                                               // 0x0460   (0x0004)  
	int32_t                                            SectionBaseY;                                               // 0x0464   (0x0004)  
	int32_t                                            ComponentSizeQuads;                                         // 0x0468   (0x0004)  
	int32_t                                            SubsectionSizeQuads;                                        // 0x046C   (0x0004)  
	int32_t                                            NumSubsections;                                             // 0x0470   (0x0004)  
	unsigned char                                      UnknownData00_6[0x4];                                       // 0x0474   (0x0004)  MISSED
	class UMaterialInterface*                          OverrideMaterial;                                           // 0x0478   (0x0008)  
	class UMaterialInterface*                          OverrideHoleMaterial;                                       // 0x0480   (0x0008)  
	TArray<FLandscapeComponentMaterialOverride>        OverrideMaterials;                                          // 0x0488   (0x0010)  
	TArray<class UMaterialInstanceConstant*>           MaterialInstances;                                          // 0x0498   (0x0010)  
	TArray<class UMaterialInstanceDynamic*>            MaterialInstancesDynamic;                                   // 0x04A8   (0x0010)  
	TArray<int8_t>                                     LODIndexToMaterialIndex;                                    // 0x04B8   (0x0010)  
	TArray<int8_t>                                     MaterialIndexToDisabledTessellationMaterial;                // 0x04C8   (0x0010)  
	class UTexture2D*                                  XYOffsetmapTexture;                                         // 0x04D8   (0x0008)  
	FVector4                                           WeightmapScaleBias;                                         // 0x04E0   (0x0010)  
	float                                              WeightmapSubsectionOffset;                                  // 0x04F0   (0x0004)  
	unsigned char                                      UnknownData01_6[0xC];                                       // 0x04F4   (0x000C)  MISSED
	FVector4                                           HeightmapScaleBias;                                         // 0x0500   (0x0010)  
	FBox                                               CachedLocalBox;                                             // 0x0510   (0x001C)  
	TLazyObjectPtr<class ULandscapeHeightfieldCollisionComponent*> CollisionComponent;                             // 0x052C   (0x001C)  
	class UTexture2D*                                  HeightmapTexture;                                           // 0x0548   (0x0008)  
	TArray<FWeightmapLayerAllocationInfo>              WeightmapLayerAllocations;                                  // 0x0550   (0x0010)  
	TArray<class UTexture2D*>                          WeightmapTextures;                                          // 0x0560   (0x0010)  
	class ULandscapeLODStreamingProxy*                 LODStreamingProxy;                                          // 0x0570   (0x0008)  
	FGuid                                              MapBuildDataId;                                             // 0x0578   (0x0010)  
	TArray<FGuid>                                      IrrelevantLights;                                           // 0x0588   (0x0010)  
	int32_t                                            CollisionMipLevel;                                          // 0x0598   (0x0004)  
	int32_t                                            SimpleCollisionMipLevel;                                    // 0x059C   (0x0004)  
	float                                              NegativeZBoundsExtension;                                   // 0x05A0   (0x0004)  
	float                                              PositiveZBoundsExtension;                                   // 0x05A4   (0x0004)  
	float                                              StaticLightingResolution;                                   // 0x05A8   (0x0004)  
	int32_t                                            ForcedLOD;                                                  // 0x05AC   (0x0004)  
	int32_t                                            LODBias;                                                    // 0x05B0   (0x0004)  
	FGuid                                              StateId;                                                    // 0x05B4   (0x0010)  
	FGuid                                              BakedTextureMaterialGuid;                                   // 0x05C4   (0x0010)  
	unsigned char                                      UnknownData02_6[0x4];                                       // 0x05D4   (0x0004)  MISSED
	class UTexture2D*                                  GIBakedBaseColorTexture;                                    // 0x05D8   (0x0008)  
	char                                               MobileBlendableLayerMask;                                   // 0x05E0   (0x0001)  
	unsigned char                                      UnknownData03_6[0x7];                                       // 0x05E1   (0x0007)  MISSED
	class UMaterialInterface*                          MobileMaterialInterface;                                    // 0x05E8   (0x0008)  
	TArray<class UMaterialInterface*>                  MobileMaterialInterfaces;                                   // 0x05F0   (0x0010)  
	TArray<class UTexture2D*>                          MobileWeightmapTextures;                                    // 0x0600   (0x0010)  
	unsigned char                                      UnknownData04_7[0x70];                                      // 0x0610   (0x0070)  MISSED


	/// Functions
	// Function /Script/Landscape.LandscapeComponent.GetMaterialInstanceDynamic
	UMaterialInstanceDynamic* GetMaterialInstanceDynamic(int32_t InIndex) // [0x343c910] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	float EditorGetPaintLayerWeightByNameAtLocation(FVector& InLocation, FName InPaintLayerName) // [0x343c830] Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
	...
	float EditorGetPaintLayerWeightAtLocation(FVector& InLocation, ULandscapeLayerInfoObject* PaintLayer) // [0x343c750] Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
...
/// Size: 0x0540 (1344 bytes) (0x000460 - 0x000540) align 16 MaxSize: 0x0540
class ULandscapeHeightfieldCollisionComponent : public UPrimitiveComponent
{ 
public:
	TArray<class ULandscapeLayerInfoObject*>           ComponentLayerInfos;                                        // 0x0460   (0x0010)  
	int32_t                                            SectionBaseX;                                               // 0x0470   (0x0004)  
	int32_t                                            SectionBaseY;                                               // 0x0474   (0x0004)  
	int32_t                                            CollisionSizeQuads;                                         // 0x0478   (0x0004)  
	float                                              CollisionScale;                                             // 0x047C   (0x0004)  
	int32_t                                            SimpleCollisionSizeQuads;                                   // 0x0480   (0x0004)  
	unsigned char                                      UnknownData00_6[0x4];                                       // 0x0484   (0x0004)  MISSED
	TArray<char>                                       CollisionQuadFlags;                                         // 0x0488   (0x0010)  
	FGuid                                              HeightfieldGuid;                                            // 0x0498   (0x0010)  
	FBox                                               CachedLocalBox;                                             // 0x04A8   (0x001C)  
	TLazyObjectPtr<class ULandscapeComponent*>         RenderComponent;                                            // 0x04C4   (0x001C)  
	unsigned char                                      UnknownData01_6[0x10];                                      // 0x04E0   (0x0010)  MISSED
	TArray<class UPhysicalMaterial*>                   CookedPhysicalMaterials;                                    // 0x04F0   (0x0010)  
	unsigned char                                      UnknownData02_7[0x40];                                      // 0x0500   (0x0040)  MISSED


	/// Functions
	// Function /Script/Landscape.LandscapeHeightfieldCollisionComponent.GetRenderComponent
	ULandscapeComponent* GetRenderComponent() // [0x343c9b0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
...
/// Size: 0x0560 (1376 bytes) (0x000540 - 0x000560) align 16 MaxSize: 0x0560
class ULandscapeMeshCollisionComponent : public ULandscapeHeightfieldCollisionComponent
{ 
public:
	FGuid                                              MeshGuid;                                                   // 0x0540   (0x0010)  
	unsigned char                                      UnknownData00_7[0x10];                                      // 0x0550   (0x0010)  MISSED
};
...
{ 
public:
	class ULandscapeMeshProxyComponent*                LandscapeMeshProxyComponent;                                // 0x0228   (0x0008)  
};
...
{ 
public:
	FGuid                                              LandscapeGuid;                                              // 0x04F8   (0x0010)  
	TArray<FIntPoint>                                  ProxyComponentBases;                                        // 0x0508   (0x0010)  
	int8_t                                             ProxyLOD;                                                   // 0x0518   (0x0001)  
	unsigned char                                      UnknownData00_7[0x7];                                       // 0x0519   (0x0007)  MISSED
};
...
{ 
public:
	TArray<class ULandscapeSplineControlPoint*>        ControlPoints;                                              // 0x0460   (0x0010)  
	TArray<class ULandscapeSplineSegment*>             Segments;                                                   // 0x0470   (0x0010)  
	TArray<class UMeshComponent*>                      CookedForeignMeshComponents;                                // 0x0480   (0x0010)  


	/// Functions
	// Function /Script/Landscape.LandscapeSplinesComponent.GetSplineMeshComponents
	// TArray<USplineMeshComponent*> GetSplineMeshComponents();                                                                 // [0x1e1c470] Final|Native|Public|BlueprintCallable 
};
...
/// Size: 0x05C0 (1472 bytes) (0x0005A0 - 0x0005C0) align 8 MaxSize: 0x05C0
class ALandscapeStreamingProxy : public ALandscapeProxy
{ 
public:
	TLazyObjectPtr<class ALandscape*>                  LandscapeActor;                                             // 0x05A0   (0x001C)  
...
static_assert(sizeof(AControlPointMeshActor) == 0x0230); // 560 bytes (0x000228 - 0x000230)
...
static_assert(sizeof(ALandscapeProxy) == 0x05A0); // 1440 bytes (0x000228 - 0x0005A0)
static_assert(sizeof(ALandscape) == 0x05A0); // 1440 bytes (0x0005A0 - 0x0005A0)
static_assert(sizeof(ALandscapeBlueprintBrushBase) == 0x0228); // 552 bytes (0x000228 - 0x000228)
...
static_assert(sizeof(ULandscapeComponent) == 0x0680); // 1664 bytes (0x000460 - 0x000680)
static_assert(sizeof(ALandscapeGizmoActor) == 0x0228); // 552 bytes (0x000228 - 0x000228)
static_assert(sizeof(ALandscapeGizmoActiveActor) == 0x0278); // 632 bytes (0x000228 - 0x000278)
static_assert(sizeof(ULandscapeGizmoRenderComponent) == 0x0460); // 1120 bytes (0x000460 - 0x000460)
...
static_assert(sizeof(ULandscapeHeightfieldCollisionComponent) == 0x0540); // 1344 bytes (0x000460 - 0x000540)
...
static_assert(sizeof(ULandscapeMeshCollisionComponent) == 0x0560); // 1376 bytes (0x000540 - 0x000560)
static_assert(sizeof(ALandscapeMeshProxyActor) == 0x0230); // 560 bytes (0x000228 - 0x000230)
...
static_assert(sizeof(ULandscapeSplinesComponent) == 0x0490); // 1168 bytes (0x000460 - 0x000490)
...
static_assert(sizeof(ALandscapeStreamingProxy) == 0x05C0); // 1472 bytes (0x0005A0 - 0x0005C0)
...
static_assert(offsetof(AControlPointMeshActor, ControlPointMeshComponent) == 0x0228);
...
static_assert(offsetof(ALandscapeProxy, SplineComponent) == 0x0228);
static_assert(offsetof(ALandscapeProxy, LandscapeGuid) == 0x0230);
static_assert(offsetof(ALandscapeProxy, LandscapeSectionOffset) == 0x0240);
static_assert(offsetof(ALandscapeProxy, LODFalloff) == 0x0250);
static_assert(offsetof(ALandscapeProxy, DefaultPhysMaterial) == 0x0278);
static_assert(offsetof(ALandscapeProxy, LandscapeMaterial) == 0x0288);
static_assert(offsetof(ALandscapeProxy, LandscapeHoleMaterial) == 0x02B0);
static_assert(offsetof(ALandscapeProxy, LandscapeMaterialsOverride) == 0x02B8);
static_assert(offsetof(ALandscapeProxy, RuntimeVirtualTextures) == 0x02D0);
static_assert(offsetof(ALandscapeProxy, VirtualTextureRenderPassType) == 0x02E8);
static_assert(offsetof(ALandscapeProxy, LandscapeComponents) == 0x02F8);
static_assert(offsetof(ALandscapeProxy, CollisionComponents) == 0x0308);
static_assert(offsetof(ALandscapeProxy, FoliageComponents) == 0x0318);
static_assert(offsetof(ALandscapeProxy, LightingChannels) == 0x03A5);
static_assert(offsetof(ALandscapeProxy, CustomDepthStencilWriteMask) == 0x03AC);
static_assert(offsetof(ALandscapeProxy, LightmassSettings) == 0x03B8);
static_assert(offsetof(ALandscapeProxy, BodyInstance) == 0x03E0);
static_assert(offsetof(ALandscapeProxy, NavigationGeometryGatheringMode) == 0x054D);
static_assert(offsetof(ALandscapeProxy, WeightmapUsageMap) == 0x0550);
...
static_assert(offsetof(ULandscapeComponent, OverrideMaterial) == 0x0478);
static_assert(offsetof(ULandscapeComponent, OverrideHoleMaterial) == 0x0480);
static_assert(offsetof(ULandscapeComponent, OverrideMaterials) == 0x0488);
static_assert(offsetof(ULandscapeComponent, MaterialInstances) == 0x0498);
static_assert(offsetof(ULandscapeComponent, MaterialInstancesDynamic) == 0x04A8);
static_assert(offsetof(ULandscapeComponent, LODIndexToMaterialIndex) == 0x04B8);
static_assert(offsetof(ULandscapeComponent, MaterialIndexToDisabledTessellationMaterial) == 0x04C8);
static_assert(offsetof(ULandscapeComponent, XYOffsetmapTexture) == 0x04D8);
...
static_assert(offsetof(ULandscapeHeightfieldCollisionComponent, ComponentLayerInfos) == 0x0460);
static_assert(offsetof(ULandscapeHeightfieldCollisionComponent, CollisionQuadFlags) == 0x0488);
static_assert(offsetof(ULandscapeHeightfieldCollisionComponent, HeightfieldGuid) == 0x0498);
static_assert(offsetof(ULandscapeHeightfieldCollisionComponent, CachedLocalBox) == 0x04A8);
static_assert(offsetof(ULandscapeHeightfieldCollisionComponent, RenderComponent) == 0x04C4);
static_assert(offsetof(ULandscapeHeightfieldCollisionComponent, CookedPhysicalMaterials) == 0x04F0);
...
static_assert(offsetof(ULandscapeMeshCollisionComponent, MeshGuid) == 0x0540);
static_assert(offsetof(ALandscapeMeshProxyActor, LandscapeMeshProxyComponent) == 0x0228);
...
static_assert(offsetof(ULandscapeSplinesComponent, ControlPoints) == 0x0460);
static_assert(offsetof(ULandscapeSplinesComponent, Segments) == 0x0470);
static_assert(offsetof(ULandscapeSplinesComponent, CookedForeignMeshComponents) == 0x0480);
...
static_assert(offsetof(ALandscapeStreamingProxy, LandscapeActor) == 0x05A0);
