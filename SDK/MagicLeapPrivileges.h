...
public:
	...
	// bool RequestPrivilegeAsync(EMagicLeapPrivilege Privilege, FDelegateProperty& ResultDelegate);                            // [0x1ad0450] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MagicLeapPrivileges.MagicLeapPrivilegesFunctionLibrary.RequestPrivilege
	bool RequestPrivilege(EMagicLeapPrivilege Privilege) // [0x1ad03d0] Final|Native|Static|Public|BlueprintCallable 
	{
	...
	bool CheckPrivilege(EMagicLeapPrivilege Privilege) // [0x1ad03d0] Final|Native|Static|Public|BlueprintCallable 
	{
		typedef bool (*FuncPtr)(EMagicLeapPrivilege);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
