...
{ 
	...
	SDK_UNDEFINED(16,307) /* TScriptInterface<Class> */ __um(CurveSource);                                         // 0x0030   (0x0010)  
};
...
public:
	...
	void K2_TwoBoneIK(FVector& RootPos, FVector& JointPos, FVector& EndPos, FVector& JointTarget, FVector& Effector, FVector& OutJointPos, FVector& OutEndPos, bool bAllowStretching, float StartStretchRatio, float MaxStretchScale) // [0x3543cb0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	{
	...
	void K2_StartProfilingTimer() // [0x3543c90] Final|Native|Static|Public|BlueprintCallable 
	{
	...
	FVector K2_MakePerlinNoiseVectorAndRemap(float X, float Y, float Z, float RangeOutMinX, float RangeOutMaxX, float RangeOutMinY, float RangeOutMaxY, float RangeOutMinZ, float RangeOutMaxZ) // [0x35439b0] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	{
	...
	float K2_MakePerlinNoiseAndRemap(float Value, float RangeOutMin, float RangeOutMax) // [0x3543890] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	{
	...
	FTransform K2_LookAt(FTransform& CurrentTransform, FVector& TargetPosition, FVector LookAtVector, bool bUseUpVector, FVector UpVector, float ClampConeInDegree) // [0x35435f0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	{
	...
	float K2_EndProfilingTimer(bool bLog, FString LogPrefix) // [0x3543500] Final|Native|Static|Public|BlueprintCallable 
	{
	...
	// float K2_DistanceBetweenTwoSocketsAndMapRange(USkeletalMeshComponent* Component, FName SocketOrBoneNameA, TEnumAsByte<ERelativeTransformSpace> SocketSpaceA, FName SocketOrBoneNameB, TEnumAsByte<ERelativeTransformSpace> SocketSpaceB, bool bRemapRange, float InRangeMin, float InRangeMax, float OutRangeMin, float OutRangeMax); // [0x3543210] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AnimGraphRuntime.KismetAnimationLibrary.K2_DirectionBetweenSockets
	FVector K2_DirectionBetweenSockets(USkeletalMeshComponent* Component, FName SocketOrBoneNameFrom, FName SocketOrBoneNameTo) // [0x3543100] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	{
	...
	// float K2_CalculateVelocityFromSockets(float DeltaSeconds, USkeletalMeshComponent* Component, FName SocketOrBoneName, FName ReferenceSocketOrBone, TEnumAsByte<ERelativeTransformSpace> SocketSpace, FVector OffsetInBoneSpace, FPositionHistory& History, int32_t NumberOfSamples, float VelocityMin, float VelocityMax, EEasingFuncType EasingType, FRuntimeFloatCurve& CustomCurve); // [0x3542ca0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AnimGraphRuntime.KismetAnimationLibrary.K2_CalculateVelocityFromPositionHistory
	float K2_CalculateVelocityFromPositionHistory(float DeltaSeconds, FVector position, FPositionHistory& History, int32_t NumberOfSamples, float VelocityMin, float VelocityMax) // [0x3542a80] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
...
{ 
public:
	SDK_UNDEFINED(16,308) /* FMulticastInlineDelegate */ __um(OnCompleted);                                        // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,309) /* FMulticastInlineDelegate */ __um(OnBlendOut);                                         // 0x0038   (0x0010)  
	SDK_UNDEFINED(16,310) /* FMulticastInlineDelegate */ __um(OnInterrupted);                                      // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,311) /* FMulticastInlineDelegate */ __um(OnNotifyBegin);                                      // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,312) /* FMulticastInlineDelegate */ __um(OnNotifyEnd);                                        // 0x0068   (0x0010)  
	...
	void OnNotifyEndReceived(FName NotifyName, FBranchingPointNotifyPayload& BranchingPointNotifyPayload) // [0x3545020] Final|Native|Protected|HasOutParms 
	{
	...
	void OnNotifyBeginReceived(FName NotifyName, FBranchingPointNotifyPayload& BranchingPointNotifyPayload) // [0x3544f30] Final|Native|Protected|HasOutParms 
	{
		typedef void (*FuncPtr)(FName, FBranchingPointNotifyPayload&);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
	...
	void OnMontageEnded(UAnimMontage* Montage, bool bInterrupted) // [0x3544e60] Final|Native|Protected 
	{
	...
	void OnMontageBlendingOut(UAnimMontage* Montage, bool bInterrupted) // [0x3544d90] Final|Native|Protected 
	{
		typedef void (*FuncPtr)(UAnimMontage*, bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[3]);
	...
	UPlayMontageCallbackProxy* CreateProxyObjectForPlayMontage(USkeletalMeshComponent* InSkeletalMeshComponent, UAnimMontage* MontageToPlay, float PlayRate, float StartingPosition, FName StartingSection) // [0x3544c00] Final|Native|Static|Public|BlueprintCallable 
	{
