...
public:
	...
	SDK_UNDEFINED(16,780) /* FMulticastInlineDelegate */ __um(OnPlanesQueryResult);                                // 0x0228   (0x0010)  
	SDK_UNDEFINED(16,781) /* FMulticastInlineDelegate */ __um(OnPersistentPlanesQueryResult);                      // 0x0238   (0x0010)  
	...
	bool RequestPlanesAsync() // [0x1acfed0] Final|Native|Public|BlueprintCallable 
	{
...
public:
	...
	// void ReorderPlaneFlags(TArray<EMagicLeapPlaneQueryFlags>& InPriority, TArray<EMagicLeapPlaneQueryFlags>& InFlagsToReorder, TArray<EMagicLeapPlaneQueryFlags>& OutReorderedFlags); // [0x1acfd50] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MagicLeapPlanes.MagicLeapPlanesFunctionLibrary.RemovePersistentQuery
	bool RemovePersistentQuery(FGuid Handle) // [0x1acfcb0] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	{
	...
	// void RemoveFlagsNotInQuery(TArray<EMagicLeapPlaneQueryFlags>& InQueryFlags, TArray<EMagicLeapPlaneQueryFlags>& InResultFlags, TArray<EMagicLeapPlaneQueryFlags>& OutFlags); // [0x1acfb30] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MagicLeapPlanes.MagicLeapPlanesFunctionLibrary.PlanesQueryBeginAsync
	// bool PlanesQueryBeginAsync(FMagicLeapPlanesQuery& Query, FDelegateProperty& ResultDelegate);                             // [0x1acf9d0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MagicLeapPlanes.MagicLeapPlanesFunctionLibrary.PlanesPersistentQueryBeginAsync
	// bool PlanesPersistentQueryBeginAsync(FMagicLeapPlanesQuery& Query, FGuid& Handle, FDelegateProperty& ResultDelegate);    // [0x1acf820] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/MagicLeapPlanes.MagicLeapPlanesFunctionLibrary.IsTrackerValid
	bool IsTrackerValid() // [0x1acf7f0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	{
		typedef bool (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	FTransform GetContentScale(AActor* ContentActor, FMagicLeapPlaneResult& PlaneResult) // [0x1acf6b0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
	...
	bool DestroyTracker() // [0x1acf680] Final|Native|Static|Public|BlueprintCallable 
	{
		typedef bool (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	bool CreateTracker() // [0x1acf650] Final|Native|Static|Public|BlueprintCallable 
	{
		typedef bool (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	FGuid AddPersistentQuery(EMagicLeapPlaneQueryType PersistentQueryType) // [0x1acf5c0] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	{
