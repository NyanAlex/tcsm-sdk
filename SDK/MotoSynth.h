...
public:
	...
	void SetSettings(FMotoSynthRuntimeSettings& InSettings) // [0x1a956d0] Final|Native|Public|HasOutParms|BlueprintCallable 
	{
	...
	void SetRPM(float InRPM, float InTimeSec) // [0x1a95600] Final|Native|Public|BlueprintCallable 
	{
	...
	bool IsEnabled() // [0x1a955d0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	void GetRPMRange(float& OutMinRPM, float& OutMaxRPM) // [0x1a954f0] Final|Native|Public|HasOutParms|BlueprintCallable 
	{
		typedef void (*FuncPtr)(float&, float&);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
