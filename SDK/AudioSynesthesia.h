...
public:
	...
	void GetNormalizedChannelConstantQAtTime(float InSeconds, int32_t InChannel, TArray<float>& OutConstantQ) // [0x1c305b0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	{
	...
	void GetChannelConstantQAtTime(float InSeconds, int32_t InChannel, TArray<float>& OutConstantQ) // [0x1c300a0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	{
		typedef void (*FuncPtr)(float, int32_t, TArray<float>&);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
...
public:
	...
	void GetNormalizedLoudnessAtTime(float InSeconds, float& OutLoudness) // [0x1c309e0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	{
	...
	void GetNormalizedChannelLoudnessAtTime(float InSeconds, int32_t InChannel, float& OutLoudness) // [0x1c306e0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	{
	...
	void GetLoudnessAtTime(float InSeconds, float& OutLoudness) // [0x1c304d0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	{
		typedef void (*FuncPtr)(float, float&);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void GetChannelLoudnessAtTime(float InSeconds, int32_t InChannel, float& OutLoudness) // [0x1c301d0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	{
		typedef void (*FuncPtr)(float, int32_t, float&);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
...
public:
	...
	void GetNormalizedChannelOnsetsBetweenTimes(float InStartSeconds, float InEndSeconds, int32_t InChannel, TArray<float>& OutOnsetTimestamps, TArray<float>& OutOnsetStrengths) // [0x1c30800] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	{
	...
	void GetChannelOnsetsBetweenTimes(float InStartSeconds, float InEndSeconds, int32_t InChannel, TArray<float>& OutOnsetTimestamps, TArray<float>& OutOnsetStrengths) // [0x1c302f0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	{
		typedef void (*FuncPtr)(float, float, int32_t, TArray<float>&, TArray<float>&);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
