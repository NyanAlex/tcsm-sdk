...
/// Size: 0x04D0 (1232 bytes) (0x000488 - 0x0004D0) align 16 MaxSize: 0x04D0
class UBaseDynamicMeshComponent : public UMeshComponent
{ 
public:
	unsigned char                                      UnknownData00_1[0x48];                                      // 0x0488   (0x0048)  MISSED
};
...
{ 
public:
	class UMaterialInterface*                          LineMaterial;                                               // 0x0488   (0x0008)  
	FBoxSphereBounds                                   Bounds;                                                     // 0x0490   (0x001C)  
	bool                                               bBoundsDirty;                                               // 0x04AC   (0x0001)  
	unsigned char                                      UnknownData00_7[0x43];                                      // 0x04AD   (0x0043)  MISSED
};
...
/// Size: 0x05E0 (1504 bytes) (0x0004D0 - 0x0005E0) align 16 MaxSize: 0x05E0
class UOctreeDynamicMeshComponent : public UBaseDynamicMeshComponent
{ 
public:
	unsigned char                                      UnknownData00_8[0x18];                                      // 0x04D0   (0x0018)  MISSED
	bool                                               bExplicitShowWireframe;                                     // 0x04E8   (0x0001)  
	unsigned char                                      UnknownData01_7[0xF7];                                      // 0x04E9   (0x00F7)  MISSED
};
...
{ 
public:
	class UMaterialInterface*                          PointMaterial;                                              // 0x0488   (0x0008)  
	FBoxSphereBounds                                   Bounds;                                                     // 0x0490   (0x001C)  
	bool                                               bBoundsDirty;                                               // 0x04AC   (0x0001)  
	unsigned char                                      UnknownData00_7[0x43];                                      // 0x04AD   (0x0043)  MISSED
};
...
public:
	...
	bool SetLineSetVisibility(FString LineSetIdentifier, bool bVisible) // [0xec6010] Final|Native|Public  
	{
		typedef bool (*FuncPtr)(FString, bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
		return func(LineSetIdentifier, bVisible);
	}
	// Function /Script/ModelingComponents.PreviewGeometry.SetLineSetMaterial
	bool SetLineSetMaterial(FString LineSetIdentifier, UMaterialInterface* NewMaterial) // [0xec5f20] Final|Native|Public  
	{
		typedef bool (*FuncPtr)(FString, UMaterialInterface*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
		return func(LineSetIdentifier, NewMaterial);
	}
	// Function /Script/ModelingComponents.PreviewGeometry.SetAllLineSetsMaterial
	void SetAllLineSetsMaterial(UMaterialInterface* Material) // [0xec5e90] Final|Native|Public  
	{
	...
	bool RemoveLineSet(FString LineSetIdentifier, bool bDestroy) // [0xec5da0] Final|Native|Public  
	{
		typedef bool (*FuncPtr)(FString, bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[3]);
		return func(LineSetIdentifier, bDestroy);
	}
	// Function /Script/ModelingComponents.PreviewGeometry.RemoveAllLineSets
	void RemoveAllLineSets(bool bDestroy) // [0xec5d10] Final|Native|Public  
	{
	...
	APreviewGeometryActor* GetActor() // [0xec5c10] Final|Native|Public|Const 
	{
		typedef class APreviewGeometryActor* (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[5]);
		return func();
	}
	// Function /Script/ModelingComponents.PreviewGeometry.FindLineSet
	ULineSetComponent* FindLineSet(FString LineSetIdentifier) // [0xec5b60] Final|Native|Public  
	{
		typedef class ULineSetComponent* (*FuncPtr)(FString);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[6]);
		return func(LineSetIdentifier);
	}
	// Function /Script/ModelingComponents.PreviewGeometry.Disconnect
	void Disconnect() // [0xec5b40] Final|Native|Public  
	{
	...
	void CreateInWorld(UWorld* World, FTransform& WithTransform) // [0xec5a20] Final|Native|Public|HasOutParms|HasDefaults 
	{
		typedef void (*FuncPtr)(UWorld*, FTransform&);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[8]);
		func(World, WithTransform);
	}
	// Function /Script/ModelingComponents.PreviewGeometry.AddLineSet
	ULineSetComponent* AddLineSet(FString LineSetIdentifier) // [0xec5970] Final|Native|Public  
	{
		typedef class ULineSetComponent* (*FuncPtr)(FString);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
...
/// Size: 0x0620 (1568 bytes) (0x0004D0 - 0x000620) align 16 MaxSize: 0x0620
class USimpleDynamicMeshComponent : public UBaseDynamicMeshComponent
{ 
public:
	EDynamicMeshTangentCalcType                        TangentsType;                                               // 0x04D0   (0x0001)  
	bool                                               bInvalidateProxyOnChange;                                   // 0x04D1   (0x0001)  
	unsigned char                                      UnknownData00_6[0x36];                                      // 0x04D2   (0x0036)  MISSED
	bool                                               bExplicitShowWireframe;                                     // 0x0508   (0x0001)  
	unsigned char                                      UnknownData01_6[0x47];                                      // 0x0509   (0x0047)  MISSED
	bool                                               bDrawOnTop;                                                 // 0x0550   (0x0001)  
	unsigned char                                      UnknownData02_7[0xCF];                                      // 0x0551   (0x00CF)  MISSED
};
...
/// Size: 0x0570 (1392 bytes) (0x000488 - 0x000570) align 16 MaxSize: 0x0570
class UTriangleSetComponent : public UMeshComponent
{ 
public:
	FBoxSphereBounds                                   Bounds;                                                     // 0x0488   (0x001C)  
	bool                                               bBoundsDirty;                                               // 0x04A4   (0x0001)  
	unsigned char                                      UnknownData00_7[0xCB];                                      // 0x04A5   (0x00CB)  MISSED
};
...
public:
	...
	// TArray<FString> GetWeightMapsFunc();                                                                                     // [0xec5c30] Final|Native|Public  
};
...
static_assert(sizeof(UBaseDynamicMeshComponent) == 0x04D0); // 1232 bytes (0x000488 - 0x0004D0)
...
static_assert(sizeof(ULineSetComponent) == 0x04F0); // 1264 bytes (0x000488 - 0x0004F0)
...
static_assert(sizeof(UOctreeDynamicMeshComponent) == 0x05E0); // 1504 bytes (0x0004D0 - 0x0005E0)
static_assert(sizeof(UPlaneDistanceFromHitMechanic) == 0x04A0); // 1184 bytes (0x000030 - 0x0004A0)
static_assert(sizeof(UPointSetComponent) == 0x04F0); // 1264 bytes (0x000488 - 0x0004F0)
...
static_assert(sizeof(APreviewGeometryActor) == 0x0228); // 552 bytes (0x000228 - 0x000228)
static_assert(sizeof(UPreviewGeometry) == 0x0080); // 128 bytes (0x000028 - 0x000080)
static_assert(sizeof(APreviewMeshActor) == 0x0228); // 552 bytes (0x000228 - 0x000228)
static_assert(sizeof(USimpleDynamicMeshComponent) == 0x0620); // 1568 bytes (0x0004D0 - 0x000620)
...
static_assert(sizeof(UTriangleSetComponent) == 0x0570); // 1392 bytes (0x000488 - 0x000570)
...
static_assert(offsetof(ULineSetComponent, LineMaterial) == 0x0488);
static_assert(offsetof(ULineSetComponent, Bounds) == 0x0490);
...
static_assert(offsetof(UPointSetComponent, PointMaterial) == 0x0488);
static_assert(offsetof(UPointSetComponent, Bounds) == 0x0490);
...
static_assert(offsetof(USimpleDynamicMeshComponent, TangentsType) == 0x04D0);
...
static_assert(offsetof(UTriangleSetComponent, Bounds) == 0x0488);
