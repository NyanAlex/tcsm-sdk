...
public:
	...
	void SetStaticGestureConfidenceThreshold(EMagicLeapHandTrackingGesture Gesture, float Confidence) // [0x1ac8f90] Final|Native|Static|Public|BlueprintCallable 
	{
	...
	// bool SetConfiguration(TArray<EMagicLeapHandTrackingGesture>& StaticGesturesToActivate, EMagicLeapHandTrackingKeypointFilterLevel KeypointsFilterLevel, EMagicLeapHandTrackingGestureFilterLevel GestureFilterLevel, bool bTrackingEnabled); // [0x1ac8e10] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MagicLeapHandTracking.MagicLeapHandTrackingFunctionLibrary.IsHoldingControl
	bool IsHoldingControl(EControllerHand Hand) // [0x1ac8d90] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	{
	...
	float GetStaticGestureConfidenceThreshold(EMagicLeapHandTrackingGesture Gesture) // [0x1ac8d10] Final|Native|Static|Public|BlueprintCallable 
	{
	...
	bool GetMotionSourceForHandKeypoint(EControllerHand Hand, EMagicLeapHandTrackingKeypoint Keypoint, FName& OutMotionSource) // [0x1ac8c00] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	{
	...
	bool GetMagicLeapHandTrackingLiveLinkSource(FLiveLinkSourceHandle& SourceHandle) // [0x1ac8b30] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	{
	...
	bool GetHandThumbTip(EControllerHand Hand, EMagicLeapGestureTransformSpace TransformSpace, FTransform& Secondary) // [0x1ac89d0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
	...
	bool GetHandKeypointForMotionSource(FName MotionSource, EMagicLeapHandTrackingKeypoint& OutKeyPoint) // [0x1ac88f0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	{
	...
	bool GetHandIndexFingerTip(EControllerHand Hand, EMagicLeapGestureTransformSpace TransformSpace, FTransform& Pointer) // [0x1ac8790] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
		typedef bool (*FuncPtr)(EControllerHand, EMagicLeapGestureTransformSpace, FTransform&);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	bool GetHandCenterNormalized(EControllerHand Hand, FVector& HandCenterNormalized) // [0x1ac86c0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
	...
	bool GetHandCenter(EControllerHand Hand, FTransform& HandCenter) // [0x1ac85a0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
	...
	bool GetGestureKeypointTransform(EControllerHand Hand, EMagicLeapHandTrackingKeypoint Keypoint, EMagicLeapGestureTransformSpace TransformSpace, FTransform& Transform) // [0x1ac8300] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
	...
	// bool GetGestureKeypoints(EControllerHand Hand, TArray<FTransform>& Keypoints);                                           // [0x1ac84b0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MagicLeapHandTracking.MagicLeapHandTrackingFunctionLibrary.GetCurrentGestureConfidence
	bool GetCurrentGestureConfidence(EControllerHand Hand, float& Confidence) // [0x1ac8220] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	{
	...
	bool GetCurrentGesture(EControllerHand Hand, EMagicLeapHandTrackingGesture& Gesture) // [0x1ac8140] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	{
	...
	// bool GetConfiguration(TArray<EMagicLeapHandTrackingGesture>& ActiveStaticGestures, EMagicLeapHandTrackingKeypointFilterLevel& KeypointsFilterLevel, EMagicLeapHandTrackingGestureFilterLevel& GestureFilterLevel, bool& bTrackingEnabled); // [0x1ac7fa0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
