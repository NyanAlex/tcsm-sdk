...
public:
	...
	bool IsCapturing() // [0x3883ea0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	EMovieSceneCaptureProtocolState GetState() // [0x31ca3e0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
...
public:
	...
	void SetImageCaptureProtocolType(UClass* ProtocolType) // [0x3884120] Final|Native|Public|BlueprintCallable 
	{
	...
	void SetAudioCaptureProtocolType(UClass* ProtocolType) // [0x3884090] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(UClass*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
	...
	UMovieSceneCaptureProtocolBase* GetImageCaptureProtocol() // [0x3883e50] Final|Native|Public|BlueprintCallable 
	{
	...
	UMovieSceneCaptureProtocolBase* GetAudioCaptureProtocol() // [0x2067030] Final|Native|Public|BlueprintCallable 
	{
		typedef class UMovieSceneCaptureProtocolBase* (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
...
public:
	...
	bool IsCaptureInProgress() // [0x3883e70] Final|Native|Static|Public|BlueprintCallable 
	{
		typedef bool (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
	...
	int32_t GetCaptureFrameNumber() // [0x3883e00] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	{
	...
	float GetCaptureElapsedTime() // [0x3883dd0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	{
	...
	UMovieSceneImageCaptureProtocolBase* FindImageCaptureProtocol() // [0x3883a70] Final|Native|Static|Public|BlueprintCallable 
	{
	...
	UMovieSceneAudioCaptureProtocolBase* FindAudioCaptureProtocol() // [0x3883a40] Final|Native|Static|Public|BlueprintCallable 
	{
...
public:
	...
	void StopCapturingFinalPixels() // [0x38842f0] Final|Native|Public|BlueprintCallable 
	{
	...
	void StartCapturingFinalPixels(FCapturedPixelsID& StreamID) // [0x38841b0] Final|Native|Public|HasOutParms|BlueprintCallable 
	{
	...
	void ResolveBuffer(UTexture* Buffer, FCapturedPixelsID& BufferID) // [0x3883f10] Final|Native|Public|HasOutParms|BlueprintCallable 
	{
	...
	void OnWarmUp() // [0x2438a30] Event|Protected|BlueprintEvent 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[3]);
	...
	void OnTick() // [0x2438a30] Event|Protected|BlueprintEvent 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[4]);
	...
	void OnStartCapture() // [0x2438a30] Event|Protected|BlueprintEvent 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	bool OnSetup() // [0x3883ee0] Native|Event|Protected|BlueprintEvent 
	{
		typedef bool (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void OnPreTick() // [0x2438a30] Event|Protected|BlueprintEvent 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void OnPixelsReceived(FCapturedPixels& Pixels, FCapturedPixelsID& ID, FFrameMetrics FrameMetrics) // [0x2438a30] Event|Protected|HasOutParms|BlueprintEvent 
	{
	...
	void OnPauseCapture() // [0x2438a30] Event|Protected|BlueprintEvent 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void OnFinalize() // [0x2438a30] Event|Protected|BlueprintEvent 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void OnCaptureFrame() // [0x2438a30] Event|Protected|BlueprintEvent 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	bool OnCanFinalize() // [0xc70b40] Native|Event|Protected|BlueprintEvent|Const 
	{
		typedef bool (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void OnBeginFinalize() // [0x2438a30] Event|Protected|BlueprintEvent 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	FFrameMetrics GetCurrentFrameMetrics() // [0x3883e30] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	FString GenerateFilename(FFrameMetrics& InFrameMetrics) // [0x3883aa0] Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	{
...
public:
	...
	void WriteImageToDisk(FCapturedPixels& PixelData, FCapturedPixelsID& StreamID, FFrameMetrics& FrameMetrics, bool bCopyImageData) // [0x3884310] Final|Native|Public|HasOutParms|BlueprintCallable 
	{
	...
	FString GenerateFilenameForCurrentFrame() // [0x3883d50] Final|Native|Public|BlueprintCallable 
	{
	...
	FString GenerateFilenameForBuffer(UTexture* Buffer, FCapturedPixelsID& StreamID) // [0x3883b90] Final|Native|Public|HasOutParms|BlueprintCallable 
	{
