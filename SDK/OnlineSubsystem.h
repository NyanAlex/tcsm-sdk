...
public:
	...
	void OnMatchReceivedTurn(FString Match, bool bDidBecomeActive) // [0x2438a30] Event|Public|BlueprintEvent 
	{
	...
	void OnMatchEnded(FString Match) // [0x2438a30] Event|Public|BlueprintEvent 
	{
