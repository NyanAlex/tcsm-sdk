...
{ 
	...
	SDK_UNDEFINED(80,679) /* TSet<UObject*> */         __um(ChaosHandlers);                                        // 0x0008   (0x0050)  
};
...
public:
	...
	FHitResult ConvertPhysicsCollisionToHitResult(FChaosPhysicsCollisionInfo& PhysicsCollision) // [0x4376850] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	{
...
public:
	...
	unsigned char                                      UnknownData02_6[0x3];                                       // 0x02CD   (0x0003)  MISSED
	...
	unsigned char                                      UnknownData04_6[0x1];                                       // 0x02EF   (0x0001)  MISSED
	class UBillboardComponent*                         SpriteComponent;                                            // 0x02F0   (0x0008)  
	unsigned char                                      UnknownData05_6[0x18];                                      // 0x02F8   (0x0018)  MISSED
	class UChaosGameplayEventDispatcher*               GameplayEventDispatcherComponent;                           // 0x0310   (0x0008)  
	unsigned char                                      UnknownData06_7[0x8];                                       // 0x0318   (0x0008)  MISSED


	/// Functions
	// Function /Script/ChaosSolverEngine.ChaosSolverActor.SetSolverActive
	void SetSolverActive(bool bActive) // [0x1266970] Native|Public|BlueprintCallable 
	{
	...
	void SetAsCurrentWorldSolver() // [0x4376940] Final|Native|Public|BlueprintCallable 
	{
...
static_assert(sizeof(AChaosSolverActor) == 0x0320); // 800 bytes (0x000228 - 0x000320)
...
static_assert(offsetof(AChaosSolverActor, Properties) == 0x0228);
static_assert(offsetof(AChaosSolverActor, ClusterUnionConnectionType) == 0x02A4);
static_assert(offsetof(AChaosSolverActor, CollisionFilterSettings) == 0x02A8);
static_assert(offsetof(AChaosSolverActor, BreakingFilterSettings) == 0x02BC);
static_assert(offsetof(AChaosSolverActor, TrailingFilterSettings) == 0x02D0);
static_assert(offsetof(AChaosSolverActor, ChaosDebugSubstepControl) == 0x02EC);
static_assert(offsetof(AChaosSolverActor, SpriteComponent) == 0x02F0);
static_assert(offsetof(AChaosSolverActor, GameplayEventDispatcherComponent) == 0x0310);
