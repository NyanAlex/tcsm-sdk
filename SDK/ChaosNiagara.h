...
{ 
public:
	SDK_UNDEFINED(80,677) /* TSet<AChaosSolverActor*> */ __um(ChaosSolverActorSet);                                // 0x0038   (0x0050)  
	...
	SDK_UNDEFINED(80,678) /* TSet<UPhysicalMaterial*> */ __um(ChaosBreakingMaterialSet);                           // 0x0138   (0x0050)  
