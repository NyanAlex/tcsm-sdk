...
{ 
public:
	class UGroomComponent*                             GroomComponent;                                             // 0x0228   (0x0008)  
};
...
public:
	...
	UGroomBindingAsset* CreateNewGroomBindingAssetWithPath(FString InDesiredPackagePath, UGroomAsset* InGroomAsset, USkeletalMesh* InSkeletalMesh, int32_t InNumInterpolationPoints, USkeletalMesh* InSourceSkeletalMeshForTransfer, int32_t InMatchingSection) // [0x970f00] Final|Native|Static|Public|BlueprintCallable 
	{
		typedef class UGroomBindingAsset* (*FuncPtr)(FString, UGroomAsset*, USkeletalMesh*, int32_t, USkeletalMesh*, int32_t);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
		return func(InDesiredPackagePath, InGroomAsset, InSkeletalMesh, InNumInterpolationPoints, InSourceSkeletalMeshForTransfer, InMatchingSection);
	}
	// Function /Script/HairStrandsCore.GroomBlueprintLibrary.CreateNewGroomBindingAsset
	UGroomBindingAsset* CreateNewGroomBindingAsset(UGroomAsset* InGroomAsset, USkeletalMesh* InSkeletalMesh, int32_t InNumInterpolationPoints, USkeletalMesh* InSourceSkeletalMeshForTransfer, int32_t InMatchingSection) // [0x970d70] Final|Native|Static|Public|BlueprintCallable 
	{
		typedef class UGroomBindingAsset* (*FuncPtr)(UGroomAsset*, USkeletalMesh*, int32_t, USkeletalMesh*, int32_t);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
		return func(InGroomAsset, InSkeletalMesh, InNumInterpolationPoints, InSourceSkeletalMeshForTransfer, InMatchingSection);
	}
	// Function /Script/HairStrandsCore.GroomBlueprintLibrary.CreateNewGeometryCacheGroomBindingAssetWithPath
	UGroomBindingAsset* CreateNewGeometryCacheGroomBindingAssetWithPath(FString DesiredPackagePath, UGroomAsset* GroomAsset, UGeometryCache* GeometryCache, int32_t NumInterpolationPoints, UGeometryCache* SourceGeometryCacheForTransfer, int32_t MatchingSection) // [0x970f00] Final|Native|Static|Public|BlueprintCallable 
	{
		typedef class UGroomBindingAsset* (*FuncPtr)(FString, UGroomAsset*, UGeometryCache*, int32_t, UGeometryCache*, int32_t);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[2]);
		return func(DesiredPackagePath, GroomAsset, GeometryCache, NumInterpolationPoints, SourceGeometryCacheForTransfer, MatchingSection);
	}
	// Function /Script/HairStrandsCore.GroomBlueprintLibrary.CreateNewGeometryCacheGroomBindingAsset
	UGroomBindingAsset* CreateNewGeometryCacheGroomBindingAsset(UGroomAsset* GroomAsset, UGeometryCache* GeometryCache, int32_t NumInterpolationPoints, UGeometryCache* SourceGeometryCacheForTransfer, int32_t MatchingSection) // [0x970d70] Final|Native|Static|Public|BlueprintCallable 
	{
		typedef class UGroomBindingAsset* (*FuncPtr)(UGroomAsset*, UGeometryCache*, int32_t, UGeometryCache*, int32_t);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[3]);
		return func(GroomAsset, GeometryCache, NumInterpolationPoints, SourceGeometryCacheForTransfer, MatchingSection);
	}
};
...
/// Size: 0x05B0 (1456 bytes) (0x000488 - 0x0005B0) align 16 MaxSize: 0x05B0
class UGroomComponent : public UMeshComponent
{ 
public:
	unsigned char                                      UnknownData00_8[0x8];                                       // 0x0488   (0x0008)  MISSED
	class UGroomAsset*                                 GroomAsset;                                                 // 0x0490   (0x0008)  
	class UGroomCache*                                 GroomCache;                                                 // 0x0498   (0x0008)  
	TArray<class UNiagaraComponent*>                   NiagaraComponents;                                          // 0x04A0   (0x0010)  
	class USkeletalMesh*                               SourceSkeletalMesh;                                         // 0x04B0   (0x0008)  
	class UGroomBindingAsset*                          BindingAsset;                                               // 0x04B8   (0x0008)  
	class UPhysicsAsset*                               PhysicsAsset;                                               // 0x04C0   (0x0008)  
	class UMaterialInterface*                          Strands_DebugMaterial;                                      // 0x04C8   (0x0008)  
	class UMaterialInterface*                          Strands_DefaultMaterial;                                    // 0x04D0   (0x0008)  
	class UMaterialInterface*                          Cards_DefaultMaterial;                                      // 0x04D8   (0x0008)  
	class UMaterialInterface*                          Meshes_DefaultMaterial;                                     // 0x04E0   (0x0008)  
	class UNiagaraSystem*                              AngularSpringsSystem;                                       // 0x04E8   (0x0008)  
	class UNiagaraSystem*                              CosseratRodsSystem;                                         // 0x04F0   (0x0008)  
	FString                                            AttachmentName;                                             // 0x04F8   (0x0010)  
	unsigned char                                      UnknownData01_6[0x48];                                      // 0x0508   (0x0048)  MISSED
	TArray<FHairGroupDesc>                             GroomGroupsDesc;                                            // 0x0550   (0x0010)  
	bool                                               bRunning;                                                   // 0x0560   (0x0001)  
	bool                                               bLooping;                                                   // 0x0561   (0x0001)  
	bool                                               bManualTick;                                                // 0x0562   (0x0001)  
	unsigned char                                      UnknownData02_6[0x1];                                       // 0x0563   (0x0001)  MISSED
	float                                              ElapsedTime;                                                // 0x0564   (0x0004)  
	unsigned char                                      UnknownData03_7[0x48];                                      // 0x0568   (0x0048)  MISSED


	/// Functions
	// Function /Script/HairStrandsCore.GroomComponent.SetGroomAsset
	void SetGroomAsset(UGroomAsset* Asset) // [0x971170] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(UGroomAsset*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
		func(Asset);
	}
	// Function /Script/HairStrandsCore.GroomComponent.SetBindingAsset
	void SetBindingAsset(UGroomBindingAsset* InBinding) // [0x9710e0] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(UGroomBindingAsset*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
		func(InBinding);
	}
...
static_assert(sizeof(AGroomActor) == 0x0230); // 560 bytes (0x000228 - 0x000230)
...
static_assert(sizeof(UGroomComponent) == 0x05B0); // 1456 bytes (0x000488 - 0x0005B0)
...
static_assert(offsetof(AGroomActor, GroomComponent) == 0x0228);
...
static_assert(offsetof(UGroomComponent, GroomAsset) == 0x0490);
static_assert(offsetof(UGroomComponent, GroomCache) == 0x0498);
static_assert(offsetof(UGroomComponent, NiagaraComponents) == 0x04A0);
static_assert(offsetof(UGroomComponent, SourceSkeletalMesh) == 0x04B0);
static_assert(offsetof(UGroomComponent, BindingAsset) == 0x04B8);
static_assert(offsetof(UGroomComponent, PhysicsAsset) == 0x04C0);
static_assert(offsetof(UGroomComponent, Strands_DebugMaterial) == 0x04C8);
static_assert(offsetof(UGroomComponent, Strands_DefaultMaterial) == 0x04D0);
static_assert(offsetof(UGroomComponent, Cards_DefaultMaterial) == 0x04D8);
static_assert(offsetof(UGroomComponent, Meshes_DefaultMaterial) == 0x04E0);
static_assert(offsetof(UGroomComponent, AngularSpringsSystem) == 0x04E8);
static_assert(offsetof(UGroomComponent, CosseratRodsSystem) == 0x04F0);
static_assert(offsetof(UGroomComponent, AttachmentName) == 0x04F8);
