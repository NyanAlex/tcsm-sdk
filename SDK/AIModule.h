...
public:
	...
	// void OnMoveCompleted(FAIRequestID RequestId, TEnumAsByte<EPathFollowingResult> MovementResult);                          // [0x43594c0] Final|Native|Public  
};
...
public:
	...
	void UnlockAIResourcesWithAnimation(UAnimInstance* AnimInstance, bool bUnlockMovement, bool UnlockAILogic) // [0x4359f50] Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable 
	{
	...
	APawn* SpawnAIFromClass(UObject* WorldContextObject, UClass* PawnClass, UBehaviorTree* BehaviorTree, FVector Location, FRotator Rotation, bool bNoCollisionFail, AActor* Owner) // [0x4359c90] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	{
	...
	void SimpleMoveToLocation(AController* Controller, FVector& Goal) // [0x4359bd0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
	...
	void SimpleMoveToActor(AController* Controller, AActor* Goal) // [0x4359b10] Final|Native|Static|Public|BlueprintCallable 
	{
	...
	void SendAIMessage(APawn* Target, FName Message, UObject* MessageSource, bool bSuccess) // [0x43597d0] Final|Native|Static|Public|BlueprintCallable 
	{
	...
	void LockAIResourcesWithAnimation(UAnimInstance* AnimInstance, bool bLockMovement, bool LockAILogic) // [0x4358e10] Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(UAnimInstance*, bool, bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	bool IsValidAIRotation(FRotator Rotation) // [0x4358c40] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	{
	...
	bool IsValidAILocation(FVector Location) // [0x4358bb0] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	{
	...
	bool IsValidAIDirection(FVector DirectionVector) // [0x4358b20] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	{
		typedef bool (*FuncPtr)(FVector);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	int32_t GetNextNavLinkIndex(AController* Controller) // [0x43587d0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	{
	...
	// TArray<FVector> GetCurrentPathPoints(AController* Controller);                                                           // [0x4358380] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.AIBlueprintHelperLibrary.GetCurrentPathIndex
	int32_t GetCurrentPathIndex(AController* Controller) // [0x43582f0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	{
		typedef int32_t (*FuncPtr)(AController*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	UNavigationPath* GetCurrentPath(AController* Controller) // [0x4358260] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	{
	...
	UBlackboardComponent* GetBlackboard(AActor* Target) // [0x43581d0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	{
	...
	AAIController* GetAIController(AActor* ControlledActor) // [0x4358040] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	{
	...
	UAIAsyncTaskBlueprintProxy* CreateMoveToProxyObject(UObject* WorldContextObject, APawn* Pawn, FVector Destination, AActor* TargetActor, float AcceptanceRadius, bool bStopOnOverlap) // [0x4357e40] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	{
...
{ 
public:
	unsigned char                                      UnknownData00_8[0x38];                                      // 0x02A0   (0x0038)  MISSED
	bool                                               bStartAILogicOnPossess : 1;                                 // 0x02D8:0 (0x0001)  
	bool                                               bStopAILogicOnUnposses : 1;                                 // 0x02D8:1 (0x0001)  
	bool                                               bLOSflag : 1;                                               // 0x02D8:2 (0x0001)  
	bool                                               bSkipExtraLOSChecks : 1;                                    // 0x02D8:3 (0x0001)  
	bool                                               bAllowStrafe : 1;                                           // 0x02D8:4 (0x0001)  
	bool                                               bWantsPlayerState : 1;                                      // 0x02D8:5 (0x0001)  
	bool                                               bSetControlRotationFromPawnOrientation : 1;                 // 0x02D8:6 (0x0001)  
	unsigned char                                      UnknownData01_5[0x7];                                       // 0x02D9   (0x0007)  MISSED
	class UPathFollowingComponent*                     PathFollowingComponent;                                     // 0x02E0   (0x0008)  
	class UBrainComponent*                             BrainComponent;                                             // 0x02E8   (0x0008)  
	class UAIPerceptionComponent*                      PerceptionComponent;                                        // 0x02F0   (0x0008)  
	class UPawnActionsComponent*                       ActionsComp;                                                // 0x02F8   (0x0008)  
	class UBlackboardComponent*                        Blackboard;                                                 // 0x0300   (0x0008)  
	class UGameplayTasksComponent*                     CachedGameplayTasksComponent;                               // 0x0308   (0x0008)  
	class UClass*                                      DefaultNavigationFilterClass;                               // 0x0310   (0x0008)  
	SDK_UNDEFINED(16,269) /* FMulticastInlineDelegate */ __um(ReceiveMoveCompleted);                               // 0x0318   (0x0010)  
	unsigned char                                      UnknownData02_7[0x8];                                       // 0x0328   (0x0008)  MISSED


	/// Functions
	// Function /Script/AIModule.AIController.UseBlackboard
	bool UseBlackboard(UBlackboardData* BlackboardAsset, UBlackboardComponent*& BlackboardComponent) // [0x435a110] Final|Native|Public|HasOutParms|BlueprintCallable 
	{
	...
	void UnclaimTaskResource(UClass* ResourceClass) // [0x4359ec0] Final|Native|Public|BlueprintCallable 
	{
	...
	void SetPathFollowingComponent(UPathFollowingComponent* NewPFComponent) // [0x43599b0] Final|Native|Public|BlueprintCallable 
	{
	...
	void SetMoveBlockDetection(bool bEnable) // [0x4359920] Final|Native|Public|BlueprintCallable 
	{
	...
	bool RunBehaviorTree(UBehaviorTree* BTAsset) // [0x4359730] Native|Public|BlueprintCallable 
	{
	...
	void OnUsingBlackBoard(UBlackboardComponent* BlackboardComp, UBlackboardData* BlackboardAsset) // [0x2438a30] Event|Protected|BlueprintEvent 
	{
	...
	void OnGameplayTaskResourcesClaimed(FGameplayResourceSet NewlyClaimed, FGameplayResourceSet FreshlyReleased) // [0x43593f0] Native|Public        
	{
	...
	// TEnumAsByte<EPathFollowingRequestResult> MoveToLocation(FVector& Dest, float AcceptanceRadius, bool bStopOnOverlap, bool bUsePathfinding, bool bProjectDestinationToNavigation, bool bCanStrafe, UClass* FilterClass, bool bAllowPartialPath); // [0x4359160] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AIModule.AIController.MoveToActor
	// TEnumAsByte<EPathFollowingRequestResult> MoveToActor(AActor* Goal, float AcceptanceRadius, bool bStopOnOverlap, bool bUsePathfinding, bool bCanStrafe, UClass* FilterClass, bool bAllowPartialPath); // [0x4358f20] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIController.K2_SetFocus
	void K2_SetFocus(AActor* NewFocus) // [0x4358d80] Final|Native|Public|BlueprintCallable 
	{
	...
	void K2_SetFocalPoint(FVector FP) // [0x4358cf0] Final|Native|Public|HasDefaults|BlueprintCallable 
	{
	...
	void K2_ClearFocus() // [0x4358cd0] Final|Native|Public|BlueprintCallable 
	{
	...
	bool HasPartialPath() // [0x4358af0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	UPathFollowingComponent* GetPathFollowingComponent() // [0x1e711b0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	// TEnumAsByte<EPathFollowingStatus> GetMoveStatus();                                                                       // [0x43587a0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIController.GetImmediateMoveDestination
	FVector GetImmediateMoveDestination() // [0x4358670] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	{
	...
	AActor* GetFocusActor() // [0x4358640] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	FVector GetFocalPointOnActor(AActor* Actor) // [0x4358590] Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	{
	...
	FVector GetFocalPoint() // [0x4358550] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	{
		typedef FVector (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	UAIPerceptionComponent* GetAIPerceptionComponent() // [0x1e79ed0] Final|Native|Public|BlueprintCallable|BlueprintPure 
	{
	...
	void ClaimTaskResource(UClass* ResourceClass) // [0x4357db0] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(UClass*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
...
public:
	...
	SDK_UNDEFINED(16,270) /* FMulticastInlineDelegate */ __um(OnPerceptionUpdated);                                // 0x0160   (0x0010)  
	SDK_UNDEFINED(16,271) /* FMulticastInlineDelegate */ __um(OnTargetPerceptionUpdated);                          // 0x0170   (0x0010)  
	SDK_UNDEFINED(16,272) /* FMulticastInlineDelegate */ __um(OnTargetPerceptionInfoUpdated);                      // 0x0180   (0x0010)  


	/// Functions
	// Function /Script/AIModule.AIPerceptionComponent.SetSenseEnabled
	void SetSenseEnabled(UClass* SenseClass, bool bEnable) // [0x4359a40] Final|Native|Public|BlueprintCallable 
	{
	...
	void RequestStimuliListenerUpdate() // [0x4359710] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
	...
	// void OnOwnerEndPlay(AActor* Actor, TEnumAsByte<EEndPlayReason> EndPlayReason);                                           // [0x4359590] Final|Native|Public  
	// Function /Script/AIModule.AIPerceptionComponent.GetPerceivedHostileActorsBySense
	// void GetPerceivedHostileActorsBySense(UClass* SenseToUse, TArray<AActor*>& OutActors);                                   // [0x4358a00] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIPerceptionComponent.GetPerceivedHostileActors
	// void GetPerceivedHostileActors(TArray<AActor*>& OutActors);                                                              // [0x4358950] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIPerceptionComponent.GetPerceivedActors
	// void GetPerceivedActors(UClass* SenseToUse, TArray<AActor*>& OutActors);                                                 // [0x4358860] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIPerceptionComponent.GetKnownPerceivedActors
	// void GetKnownPerceivedActors(UClass* SenseToUse, TArray<AActor*>& OutActors);                                            // [0x43586b0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIPerceptionComponent.GetCurrentlyPerceivedActors
	// void GetCurrentlyPerceivedActors(UClass* SenseToUse, TArray<AActor*>& OutActors);                                        // [0x4358460] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIPerceptionComponent.GetActorsPerception
	bool GetActorsPerception(AActor* Actor, FActorPerceptionBlueprintInfo& Info) // [0x43580d0] Final|Native|Public|HasOutParms|BlueprintCallable 
	{
	...
	void ForgetAll() // [0x4358020] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[9]);
...
public:
	...
	void UnregisterFromSense(UClass* SenseClass) // [0x435a080] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(UClass*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
	...
	void UnregisterFromPerceptionSystem() // [0x435a060] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
	...
	void RegisterWithPerceptionSystem() // [0x43596f0] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[2]);
	...
	void RegisterForSense(UClass* SenseClass) // [0x4359660] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(UClass*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[3]);
...
public:
	...
	void ReportPerceptionEvent(UObject* WorldContextObject, UAISenseEvent* PerceptionEvent) // [0x435e940] Final|Native|Static|Public|BlueprintCallable 
	{
	...
	void ReportEvent(UAISenseEvent* PerceptionEvent) // [0x435e6d0] Final|Native|Public|BlueprintCallable 
	{
	...
	bool RegisterPerceptionStimuliSource(UObject* WorldContextObject, UClass* Sense, AActor* Target) // [0x435e390] Final|Native|Static|Public|BlueprintCallable 
	{
	...
	// void OnPerceptionStimuliSourceEndPlay(AActor* Actor, TEnumAsByte<EEndPlayReason> EndPlayReason);                         // [0x435e2c0] Final|Native|Protected 
	// Function /Script/AIModule.AIPerceptionSystem.GetSenseClassForStimulus
	UClass* GetSenseClassForStimulus(UObject* WorldContextObject, FAIStimulus& Stimulus) // [0x435e180] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	{
...
public:
	...
	// float OnUpdate(TArray<UAISenseEvent*>& EventsToProcess);                                                                 // [0x2438a30] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/AIModule.AISense_Blueprint.OnListenerUpdated
	void OnListenerUpdated(AActor* ActorListener, UAIPerceptionComponent* PerceptionComponent) // [0x2438a30] Event|Public|BlueprintEvent 
	{
	...
	void OnListenerUnregistered(AActor* ActorListener, UAIPerceptionComponent* PerceptionComponent) // [0x2438a30] Event|Public|BlueprintEvent 
	{
		typedef void (*FuncPtr)(AActor*, UAIPerceptionComponent*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[2]);
	...
	void OnListenerRegistered(AActor* ActorListener, UAIPerceptionComponent* PerceptionComponent) // [0x2438a30] Event|Public|BlueprintEvent 
	{
		typedef void (*FuncPtr)(AActor*, UAIPerceptionComponent*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[3]);
	...
	void K2_OnNewPawn(APawn* NewPawn) // [0x2438a30] Event|Public|BlueprintEvent 
	{
	...
	// void GetAllListenerComponents(TArray<UAIPerceptionComponent*>& ListenerComponents);                                      // [0x435e0d0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AISense_Blueprint.GetAllListenerActors
	// void GetAllListenerActors(TArray<AActor*>& ListenerActors);                                                              // [0x435e020] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	void ReportDamageEvent(UObject* WorldContextObject, AActor* DamagedActor, AActor* Instigator, float DamageAmount, FVector EventLocation, FVector HitLocation, FName Tag) // [0x435e490] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	{
...
public:
	...
	void ReportNoiseEvent(UObject* WorldContextObject, FVector NoiseLocation, float Loudness, AActor* Instigator, float MaxRange, FName Tag) // [0x435e760] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	{
...
public:
	...
	void RequestPawnPredictionEvent(APawn* Requestor, AActor* PredictedActor, float PredictionTime) // [0x435eb10] Final|Native|Static|Public|BlueprintCallable 
	{
	...
	void RequestControllerPredictionEvent(AAIController* Requestor, AActor* PredictedActor, float PredictionTime) // [0x435ea00] Final|Native|Static|Public|BlueprintCallable 
	{
...
public:
	...
	void AILoggingVerbose() // [0x1444fc0] Exec|Native|Public   
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
	...
	void AIIgnorePlayers() // [0x4004e70] Exec|Native|Public   
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
...
{ 
public:
	SDK_UNDEFINED(16,273) /* FMulticastInlineDelegate */ __um(OnRequestFailed);                                    // 0x0070   (0x0010)  
	SDK_UNDEFINED(16,274) /* FMulticastInlineDelegate */ __um(OnMoveFinished);                                     // 0x0080   (0x0010)  
...
public:
	...
	UAITask_RunEQS* RunEQS(AAIController* Controller, UEnvQuery* QueryTemplate) // [0x435ec20] Final|Native|Static|Public|BlueprintCallable 
	{
...
public:
	...
	void StopLogic(FString Reason) // [0x4363ae0] Native|Public|BlueprintCallable 
	{
	...
	void StartLogic() // [0x1e10600] Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
	...
	void RestartLogic() // [0x1e10620] Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[2]);
	...
	bool IsRunning() // [0x4363040] Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef bool (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[3]);
	...
	bool IsPaused() // [0x4363010] Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef bool (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[4]);
...
public:
	...
	void SetDynamicSubtree(FGameplayTag InjectTag, UBehaviorTree* BehaviorAsset) // [0x4363110] Native|Public|BlueprintCallable 
	{
	...
	float GetTagCooldownEndTime(FGameplayTag CooldownTag) // [0x4362870] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	void AddCooldownTagDuration(FGameplayTag CooldownTag, float CooldownDuration, bool bAddToExistingDuration) // [0x43624e0] Final|Native|Public|BlueprintCallable 
	{
...
public:
	...
	UBlackboardData* GetBlackboardAsset() // [0x14a4f20] Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
...
public:
	...
	void SetValueAsVector(FName& KeyName, FVector VectorValue) // [0x43639f0] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
	...
	void SetValueAsString(FName& KeyName, FString StringValue) // [0x43638b0] Final|Native|Public|HasOutParms|BlueprintCallable 
	{
	...
	void SetValueAsRotator(FName& KeyName, FRotator VectorValue) // [0x43637c0] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
	...
	void SetValueAsObject(FName& KeyName, UObject* ObjectValue) // [0x43636f0] Final|Native|Public|HasOutParms|BlueprintCallable 
	{
	...
	void SetValueAsName(FName& KeyName, FName NameValue) // [0x4363620] Final|Native|Public|HasOutParms|BlueprintCallable 
	{
	...
	void SetValueAsInt(FName& KeyName, int32_t IntValue) // [0x4363550] Final|Native|Public|HasOutParms|BlueprintCallable 
	{
	...
	void SetValueAsFloat(FName& KeyName, float FloatValue) // [0x4363470] Final|Native|Public|HasOutParms|BlueprintCallable 
	{
	...
	void SetValueAsEnum(FName& KeyName, char EnumValue) // [0x4363390] Final|Native|Public|HasOutParms|BlueprintCallable 
	{
	...
	void SetValueAsClass(FName& KeyName, UClass* ClassValue) // [0x43632c0] Final|Native|Public|HasOutParms|BlueprintCallable 
	{
	...
	void SetValueAsBool(FName& KeyName, bool BoolValue) // [0x43631e0] Final|Native|Public|HasOutParms|BlueprintCallable 
	{
	...
	bool IsVectorValueSet(FName& KeyName) // [0x4363070] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	{
	...
	FVector GetValueAsVector(FName& KeyName) // [0x4362f00] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	{
	...
	FString GetValueAsString(FName& KeyName) // [0x4362e20] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	{
	...
	FRotator GetValueAsRotator(FName& KeyName) // [0x4362d70] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	{
	...
	UObject* GetValueAsObject(FName& KeyName) // [0x4362cd0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	{
	...
	FName GetValueAsName(FName& KeyName) // [0x4362c30] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	{
	...
	int32_t GetValueAsInt(FName& KeyName) // [0x4362b90] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	{
	...
	float GetValueAsFloat(FName& KeyName) // [0x4362af0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	{
	...
	char GetValueAsEnum(FName& KeyName) // [0x4362a50] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	{
	...
	UClass* GetValueAsClass(FName& KeyName) // [0x43629b0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	{
	...
	bool GetValueAsBool(FName& KeyName) // [0x4362910] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	{
		typedef bool (*FuncPtr)(FName&);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[20]);
	...
	bool GetRotationFromEntry(FName& KeyName, FRotator& ResultRotation) // [0x4362780] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	{
	...
	bool GetLocationFromEntry(FName& KeyName, FVector& ResultLocation) // [0x4362690] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	{
	...
	void ClearValue(FName& KeyName) // [0x4362600] Final|Native|Public|HasOutParms|BlueprintCallable 
	{
...
public:
	...
	void ReceiveTickAI(AAIController* OwnerController, APawn* ControlledPawn, float DeltaSeconds) // [0x2438a30] Event|Protected|BlueprintEvent 
	{
	...
	void ReceiveTick(AActor* OwnerActor, float DeltaSeconds) // [0x2438a30] Event|Protected|BlueprintEvent 
	{
	...
	void ReceiveObserverDeactivatedAI(AAIController* OwnerController, APawn* ControlledPawn) // [0x2438a30] Event|Protected|BlueprintEvent 
	{
	...
	void ReceiveObserverDeactivated(AActor* OwnerActor) // [0x2438a30] Event|Protected|BlueprintEvent 
	{
		typedef void (*FuncPtr)(AActor*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[3]);
	...
	void ReceiveObserverActivatedAI(AAIController* OwnerController, APawn* ControlledPawn) // [0x2438a30] Event|Protected|BlueprintEvent 
	{
		typedef void (*FuncPtr)(AAIController*, APawn*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[4]);
	...
	void ReceiveObserverActivated(AActor* OwnerActor) // [0x2438a30] Event|Protected|BlueprintEvent 
	{
		typedef void (*FuncPtr)(AActor*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[5]);
	...
	void ReceiveExecutionStartAI(AAIController* OwnerController, APawn* ControlledPawn) // [0x2438a30] Event|Protected|BlueprintEvent 
	{
		typedef void (*FuncPtr)(AAIController*, APawn*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[6]);
	...
	void ReceiveExecutionStart(AActor* OwnerActor) // [0x2438a30] Event|Protected|BlueprintEvent 
	{
		typedef void (*FuncPtr)(AActor*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[7]);
	...
	// void ReceiveExecutionFinishAI(AAIController* OwnerController, APawn* ControlledPawn, TEnumAsByte<EBTNodeResult> NodeResult); // [0x2438a30] Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTDecorator_BlueprintBase.ReceiveExecutionFinish
	// void ReceiveExecutionFinish(AActor* OwnerActor, TEnumAsByte<EBTNodeResult> NodeResult);                                  // [0x2438a30] Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTDecorator_BlueprintBase.PerformConditionCheckAI
	bool PerformConditionCheckAI(AAIController* OwnerController, APawn* ControlledPawn) // [0x2438a30] Event|Protected|BlueprintEvent 
	{
	...
	bool PerformConditionCheck(AActor* OwnerActor) // [0x2438a30] Event|Protected|BlueprintEvent 
	{
	...
	bool IsDecoratorObserverActive() // [0x4362fe0] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	{
		typedef bool (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[12]);
	...
	bool IsDecoratorExecutionActive() // [0x4362fb0] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	{
		typedef bool (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[13]);
...
public:
	...
	void StopUsingExternalEvent(UBTNode* NodeOwner) // [0x408fe00] Final|Native|Static|Public|BlueprintCallable 
	{
	...
	void StartUsingExternalEvent(UBTNode* NodeOwner, AActor* OwningActor) // [0x413ab60] Final|Native|Static|Public|BlueprintCallable 
	{
	...
	void SetBlackboardValueAsVector(UBTNode* NodeOwner, FBlackboardKeySelector& Key, FVector Value) // [0x4367f90] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
	...
	void SetBlackboardValueAsString(UBTNode* NodeOwner, FBlackboardKeySelector& Key, FString Value) // [0x4367e00] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	{
	...
	void SetBlackboardValueAsRotator(UBTNode* NodeOwner, FBlackboardKeySelector& Key, FRotator Value) // [0x4367cb0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
	...
	void SetBlackboardValueAsObject(UBTNode* NodeOwner, FBlackboardKeySelector& Key, UObject* Value) // [0x4367b70] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	{
	...
	void SetBlackboardValueAsName(UBTNode* NodeOwner, FBlackboardKeySelector& Key, FName Value) // [0x4367a30] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	{
	...
	void SetBlackboardValueAsInt(UBTNode* NodeOwner, FBlackboardKeySelector& Key, int32_t Value) // [0x43678f0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	{
	...
	void SetBlackboardValueAsFloat(UBTNode* NodeOwner, FBlackboardKeySelector& Key, float Value) // [0x43677a0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	{
	...
	void SetBlackboardValueAsEnum(UBTNode* NodeOwner, FBlackboardKeySelector& Key, char Value) // [0x4367660] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	{
	...
	void SetBlackboardValueAsClass(UBTNode* NodeOwner, FBlackboardKeySelector& Key, UClass* Value) // [0x4367520] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	{
	...
	void SetBlackboardValueAsBool(UBTNode* NodeOwner, FBlackboardKeySelector& Key, bool Value) // [0x43673e0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	{
	...
	UBlackboardComponent* GetOwnersBlackboard(UBTNode* NodeOwner) // [0x43672c0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	{
	...
	UBehaviorTreeComponent* GetOwnerComponent(UBTNode* NodeOwner) // [0x4367230] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	{
	...
	FVector GetBlackboardValueAsVector(UBTNode* NodeOwner, FBlackboardKeySelector& Key) // [0x4367120] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	{
	...
	FString GetBlackboardValueAsString(UBTNode* NodeOwner, FBlackboardKeySelector& Key) // [0x4366fe0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	{
	...
	FRotator GetBlackboardValueAsRotator(UBTNode* NodeOwner, FBlackboardKeySelector& Key) // [0x4366ed0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	{
	...
	UObject* GetBlackboardValueAsObject(UBTNode* NodeOwner, FBlackboardKeySelector& Key) // [0x4366dd0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	{
	...
	FName GetBlackboardValueAsName(UBTNode* NodeOwner, FBlackboardKeySelector& Key) // [0x4366cc0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	{
	...
	int32_t GetBlackboardValueAsInt(UBTNode* NodeOwner, FBlackboardKeySelector& Key) // [0x4366bc0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	{
	...
	float GetBlackboardValueAsFloat(UBTNode* NodeOwner, FBlackboardKeySelector& Key) // [0x4366ac0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	{
	...
	char GetBlackboardValueAsEnum(UBTNode* NodeOwner, FBlackboardKeySelector& Key) // [0x43669c0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	{
	...
	UClass* GetBlackboardValueAsClass(UBTNode* NodeOwner, FBlackboardKeySelector& Key) // [0x43668c0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	{
	...
	bool GetBlackboardValueAsBool(UBTNode* NodeOwner, FBlackboardKeySelector& Key) // [0x43667c0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	{
	...
	AActor* GetBlackboardValueAsActor(UBTNode* NodeOwner, FBlackboardKeySelector& Key) // [0x43666c0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	{
	...
	void ClearBlackboardValueAsVector(UBTNode* NodeOwner, FBlackboardKeySelector& Key) // [0x4366520] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	{
	...
	void ClearBlackboardValue(UBTNode* NodeOwner, FBlackboardKeySelector& Key) // [0x4366520] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	{
		typedef void (*FuncPtr)(UBTNode*, FBlackboardKeySelector&);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
...
public:
	...
	void ReceiveSearchStartAI(AAIController* OwnerController, APawn* ControlledPawn) // [0x2438a30] Event|Protected|BlueprintEvent 
	{
		typedef void (*FuncPtr)(AAIController*, APawn*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[2]);
	...
	void ReceiveSearchStart(AActor* OwnerActor) // [0x2438a30] Event|Protected|BlueprintEvent 
	{
		typedef void (*FuncPtr)(AActor*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[3]);
	...
	void ReceiveDeactivationAI(AAIController* OwnerController, APawn* ControlledPawn) // [0x2438a30] Event|Protected|BlueprintEvent 
	{
		typedef void (*FuncPtr)(AAIController*, APawn*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[4]);
	...
	void ReceiveDeactivation(AActor* OwnerActor) // [0x2438a30] Event|Protected|BlueprintEvent 
	{
		typedef void (*FuncPtr)(AActor*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[5]);
	...
	void ReceiveActivationAI(AAIController* OwnerController, APawn* ControlledPawn) // [0x2438a30] Event|Protected|BlueprintEvent 
	{
		typedef void (*FuncPtr)(AAIController*, APawn*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[6]);
	...
	void ReceiveActivation(AActor* OwnerActor) // [0x2438a30] Event|Protected|BlueprintEvent 
	{
		typedef void (*FuncPtr)(AActor*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[7]);
	...
	bool IsServiceActive() // [0x4367350] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	{
		typedef bool (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[8]);
...
public:
	...
	void SetFinishOnMessageWithId(FName MessageName, int32_t RequestId) // [0x4368170] Final|Native|Protected|BlueprintCallable 
	{
		typedef void (*FuncPtr)(FName, int32_t);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
	...
	void SetFinishOnMessage(FName MessageName) // [0x43680e0] Final|Native|Protected|BlueprintCallable 
	{
		typedef void (*FuncPtr)(FName);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
	...
	void ReceiveExecuteAI(AAIController* OwnerController, APawn* ControlledPawn) // [0x2438a30] Event|Protected|BlueprintEvent 
	{
		typedef void (*FuncPtr)(AAIController*, APawn*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[4]);
	...
	void ReceiveExecute(AActor* OwnerActor) // [0x2438a30] Event|Protected|BlueprintEvent 
	{
		typedef void (*FuncPtr)(AActor*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[5]);
	...
	void ReceiveAbortAI(AAIController* OwnerController, APawn* ControlledPawn) // [0x2438a30] Event|Protected|BlueprintEvent 
	{
		typedef void (*FuncPtr)(AAIController*, APawn*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[6]);
	...
	void ReceiveAbort(AActor* OwnerActor) // [0x2438a30] Event|Protected|BlueprintEvent 
	{
		typedef void (*FuncPtr)(AActor*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[7]);
	...
	bool IsTaskExecuting() // [0x43673b0] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	{
		typedef bool (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[8]);
	...
	bool IsTaskAborting() // [0x4367380] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	{
		typedef bool (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[9]);
	...
	void FinishExecute(bool bSuccess) // [0x4366630] Final|Native|Protected|BlueprintCallable 
	{
		typedef void (*FuncPtr)(bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[10]);
	...
	void FinishAbort() // [0x4366610] Final|Native|Protected|BlueprintCallable 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[11]);
...
public:
	...
	void OnNavDataRegistered(ANavigationData* NavData) // [0x4372840] Final|Native|Protected 
	{
	...
	void OnActorBump(AActor* SelfActor, AActor* OtherActor, FVector NormalImpulse, FHitResult& Hit) // [0x43726a0] Native|Public|HasOutParms|HasDefaults 
	{
	...
	FVector GetPathDestination() // [0x4372290] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	{
		typedef FVector (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[2]);
	...
	// TEnumAsByte<EPathFollowingAction> GetPathActionType();                                                                   // [0x4372260] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	void SuspendCrowdSteering(bool bSuspend) // [0x436b670] Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
...
public:
	...
	void ProvideSingleLocation(UObject* QuerierObject, AActor* QuerierActor, FVector& ResultingLocation) // [0x2438a30] Event|Public|HasOutParms|HasDefaults|BlueprintEvent|Const 
	{
	...
	void ProvideSingleActor(UObject* QuerierObject, AActor* QuerierActor, AActor*& ResultingActor) // [0x2438a30] Event|Public|HasOutParms|BlueprintEvent|Const 
	{
	...
	// void ProvideLocationsSet(UObject* QuerierObject, AActor* QuerierActor, TArray<FVector>& ResultingLocationSet);           // [0x2438a30] Event|Public|HasOutParms|BlueprintEvent|Const 
	// Function /Script/AIModule.EnvQueryContext_BlueprintBase.ProvideActorsSet
	// void ProvideActorsSet(UObject* QuerierObject, AActor* QuerierActor, TArray<AActor*>& ResultingActorsSet);                // [0x2438a30] Event|Public|HasOutParms|BlueprintEvent|Const 
};
...
public:
	...
	UObject* GetQuerier() // [0x436b640] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	// void DoItemGeneration(TArray<FVector>& ContextLocations);                                                                // [0x2438a30] Event|Public|HasOutParms|BlueprintEvent|Const 
	// Function /Script/AIModule.EnvQueryGenerator_BlueprintBase.AddGeneratedVector
	void AddGeneratedVector(FVector GeneratedVector) // [0x436b5b0] Final|Native|Public|HasDefaults|BlueprintCallable|Const 
	{
		typedef void (*FuncPtr)(FVector);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[2]);
	...
	void AddGeneratedActor(AActor* GeneratedActor) // [0x436b520] Final|Native|Public|BlueprintCallable|Const 
	{
		typedef void (*FuncPtr)(AActor*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[3]);
...
public:
	...
	SDK_UNDEFINED(16,275) /* FMulticastInlineDelegate */ __um(OnQueryFinishedEvent);                               // 0x0068   (0x0010)  


	/// Functions
	// Function /Script/AIModule.EnvQueryInstanceBlueprintWrapper.SetNamedParam
	void SetNamedParam(FName ParamName, float Value) // [0x436f200] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(FName, float);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
	...
	// TArray<FVector> GetResultsAsLocations();                                                                                 // [0x436eff0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.EnvQueryInstanceBlueprintWrapper.GetResultsAsActors
	// TArray<AActor*> GetResultsAsActors();                                                                                    // [0x436ef70] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.EnvQueryInstanceBlueprintWrapper.GetQueryResultsAsLocations
	// bool GetQueryResultsAsLocations(TArray<FVector>& ResultLocations);                                                       // [0x436eeb0] Final|Native|Public|HasOutParms|BlueprintCallable|Const 
	// Function /Script/AIModule.EnvQueryInstanceBlueprintWrapper.GetQueryResultsAsActors
	// bool GetQueryResultsAsActors(TArray<AActor*>& ResultActors);                                                             // [0x436edf0] Final|Native|Public|HasOutParms|BlueprintCallable|Const 
	// Function /Script/AIModule.EnvQueryInstanceBlueprintWrapper.GetItemScore
	float GetItemScore(int32_t ItemIndex) // [0x436ed50] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	// void EQSQueryDoneSignature__DelegateSignature(UEnvQueryInstanceBlueprintWrapper* QueryInstance, TEnumAsByte<EEnvQueryStatus> QueryStatus); // [0x2438a30] MulticastDelegate|Public|Delegate 
};
...
public:
	...
	// UEnvQueryInstanceBlueprintWrapper* RunEQSQuery(UObject* WorldContextObject, UEnvQuery* QueryTemplate, UObject* Querier, TEnumAsByte<EEnvQueryRunMode> RunMode, UClass* WrapperClass); // [0x436f070] Final|Native|Static|Public|BlueprintCallable 
};
...
{ 
public:
	unsigned char                                      UnknownData00_1[0x40];                                      // 0x0460   (0x0040)  MISSED
};
...
public:
	...
	class UNavLinkCustomComponent*                     SmartLinkComp;                                              // 0x0258   (0x0008)  
	bool                                               bSmartLinkIsRelevant;                                       // 0x0260   (0x0001)  
	unsigned char                                      UnknownData01_6[0x7];                                       // 0x0261   (0x0007)  MISSED
	SDK_UNDEFINED(16,276) /* FMulticastInlineDelegate */ __um(OnSmartLinkReached);                                 // 0x0268   (0x0010)  


	/// Functions
	// Function /Script/AIModule.NavLinkProxy.SetSmartLinkEnabled
	void SetSmartLinkEnabled(bool bEnabled) // [0x4372bc0] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
	...
	void ResumePathFollowing(AActor* Agent) // [0x43729d0] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(AActor*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
	...
	void ReceiveSmartLinkReached(AActor* Agent, FVector& Destination) // [0x2438a30] Event|Public|HasOutParms|HasDefaults|BlueprintEvent 
	{
	...
	bool IsSmartLinkEnabled() // [0x4372320] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef bool (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[3]);
	...
	bool HasMovingAgents() // [0x43722f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef bool (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[4]);
...
public:
	...
	bool SetLocalNavigationGridDensity(UObject* WorldContextObject, float CellSize) // [0x4372a60] Final|Native|Static|Public|BlueprintCallable 
	{
	...
	void RemoveLocalNavigationGrid(UObject* WorldContextObject, int32_t GridId, bool bRebuildGrids) // [0x43728d0] Final|Native|Static|Public|BlueprintCallable 
	{
	...
	// bool FindLocalNavigationGridPath(UObject* WorldContextObject, FVector& Start, FVector& End, TArray<FVector>& PathPoints); // [0x4372050] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AIModule.NavLocalGridManager.AddLocalNavigationGridForPoints
	// int32_t AddLocalNavigationGridForPoints(UObject* WorldContextObject, TArray<FVector>& Locations, int32_t Radius2D, float Height, bool bRebuildGrids); // [0x4371da0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.NavLocalGridManager.AddLocalNavigationGridForPoint
	int32_t AddLocalNavigationGridForPoint(UObject* WorldContextObject, FVector& Location, int32_t Radius2D, float Height, bool bRebuildGrids) // [0x4371be0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
	...
	int32_t AddLocalNavigationGridForCapsule(UObject* WorldContextObject, FVector& Location, float CapsuleRadius, float CapsuleHalfHeight, int32_t Radius2D, float Height, bool bRebuildGrids) // [0x43719c0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
	...
	int32_t AddLocalNavigationGridForBox(UObject* WorldContextObject, FVector& Location, FVector Extent, FRotator Rotation, int32_t Radius2D, float Height, bool bRebuildGrids) // [0x4371780] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
...
public:
	...
	// TEnumAsByte<EAIRequestPriority> GetActionPriority();                                                                     // [0x3fc1020] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.PawnAction.Finish
	// void Finish(TEnumAsByte<EPawnActionResult> WithResult);                                                                  // [0x43721e0] Native|Protected|BlueprintCallable 
	// Function /Script/AIModule.PawnAction.CreateActionInstance
	UPawnAction* CreateActionInstance(UObject* WorldContextObject, UClass* ActionClass) // [0x4371f80] Final|Native|Static|Public|BlueprintCallable 
	{
...
public:
	...
	void ActionTick(APawn* ControlledPawn, float DeltaSeconds) // [0x2438a30] Event|Public|BlueprintEvent 
	{
	...
	void ActionStart(APawn* ControlledPawn) // [0x2438a30] Event|Public|BlueprintEvent 
	{
		typedef void (*FuncPtr)(APawn*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
	...
	void ActionResume(APawn* ControlledPawn) // [0x2438a30] Event|Public|BlueprintEvent 
	{
		typedef void (*FuncPtr)(APawn*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[2]);
	...
	void ActionPause(APawn* ControlledPawn) // [0x2438a30] Event|Public|BlueprintEvent 
	{
		typedef void (*FuncPtr)(APawn*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[3]);
	...
	// void ActionFinished(APawn* ControlledPawn, TEnumAsByte<EPawnActionResult> WithResult);                                   // [0x2438a30] Event|Public|BlueprintEvent 
};
...
public:
	...
	// bool K2_PushAction(UPawnAction* NewAction, TEnumAsByte<EAIRequestPriority> Priority, UObject* Instigator);               // [0x4372590] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.PawnActionsComponent.K2_PerformAction
	// bool K2_PerformAction(APawn* Pawn, UPawnAction* Action, TEnumAsByte<EAIRequestPriority> Priority);                       // [0x4372490] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AIModule.PawnActionsComponent.K2_ForceAbortAction
	// TEnumAsByte<EPawnActionAbortState> K2_ForceAbortAction(UPawnAction* ActionToAbort);                                      // [0x43723f0] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.PawnActionsComponent.K2_AbortAction
	// TEnumAsByte<EPawnActionAbortState> K2_AbortAction(UPawnAction* ActionToAbort);                                           // [0x4372350] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	SDK_UNDEFINED(16,277) /* FMulticastInlineDelegate */ __um(OnSeePawn);                                          // 0x00D0   (0x0010)  
	SDK_UNDEFINED(16,278) /* FMulticastInlineDelegate */ __um(OnHearNoise);                                        // 0x00E0   (0x0010)  
	...
	void SetSensingUpdatesEnabled(bool bEnabled) // [0x1e06e60] BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
	...
	void SetSensingInterval(float NewSensingInterval) // [0x1e10570] BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	{
	...
	void SetPeripheralVisionAngle(float NewPeripheralVisionAngle) // [0x4372b30] BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(float);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[2]);
	...
	void SeePawnDelegate__DelegateSignature(APawn* Pawn) // [0x2438a30] MulticastDelegate|Public|Delegate 
	{
		typedef void (*FuncPtr)(APawn*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[3]);
	...
	void HearNoiseDelegate__DelegateSignature(APawn* Instigator, FVector& Location, float Volume) // [0x2438a30] MulticastDelegate|Public|Delegate|HasOutParms|HasDefaults 
	{
	...
	float GetPeripheralVisionCosine() // [0x43722d0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	float GetPeripheralVisionAngle() // [0x360a0d0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef float (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[6]);
...
static_assert(sizeof(AAIController) == 0x0330); // 816 bytes (0x0002A0 - 0x000330)
...
static_assert(sizeof(UEQSRenderingComponent) == 0x04A0); // 1184 bytes (0x000460 - 0x0004A0)
...
static_assert(sizeof(ANavLinkProxy) == 0x0278); // 632 bytes (0x000228 - 0x000278)
...
static_assert(offsetof(AAIController, PathFollowingComponent) == 0x02E0);
static_assert(offsetof(AAIController, BrainComponent) == 0x02E8);
static_assert(offsetof(AAIController, PerceptionComponent) == 0x02F0);
static_assert(offsetof(AAIController, ActionsComp) == 0x02F8);
static_assert(offsetof(AAIController, Blackboard) == 0x0300);
static_assert(offsetof(AAIController, CachedGameplayTasksComponent) == 0x0308);
static_assert(offsetof(AAIController, DefaultNavigationFilterClass) == 0x0310);
...
static_assert(offsetof(ANavLinkProxy, PointLinks) == 0x0238);
static_assert(offsetof(ANavLinkProxy, SegmentLinks) == 0x0248);
static_assert(offsetof(ANavLinkProxy, SmartLinkComp) == 0x0258);
