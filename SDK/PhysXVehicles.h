...
public:
	...
	void SetUseAutoGears(bool bUseAuto) // [0x1be2690] Final|Native|Public|BlueprintCallable 
	{
	...
	void SetThrottleInput(float Throttle) // [0x1be2610] Final|Native|Public|BlueprintCallable 
	{
	...
	void SetTargetGear(int32_t GearNum, bool bImmediate) // [0x1be2540] Final|Native|Public|BlueprintCallable 
	{
	...
	void SetSteeringInput(float Steering) // [0x1be24c0] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(float);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void SetHandbrakeInput(bool bNewHandbrake) // [0x1be2360] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void SetGroupsToIgnoreMask(FNavAvoidanceMask& GroupMask) // [0x1be22d0] Final|Native|Public|HasOutParms|BlueprintCallable 
	{
	...
	void SetGroupsToIgnore(int32_t GroupFlags) // [0x1be2240] Final|Native|Public|BlueprintCallable 
	{
	...
	void SetGroupsToAvoidMask(FNavAvoidanceMask& GroupMask) // [0x1be21b0] Final|Native|Public|HasOutParms|BlueprintCallable 
	{
		typedef void (*FuncPtr)(FNavAvoidanceMask&);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void SetGroupsToAvoid(int32_t GroupFlags) // [0x1be2120] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(int32_t);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void SetGearUp(bool bNewGearUp) // [0x1be2090] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void SetGearDown(bool bNewGearDown) // [0x1be2000] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void SetBrakeInput(float Brake) // [0x1be1de0] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(float);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void SetAvoidanceGroupMask(FNavAvoidanceMask& GroupMask) // [0x1be1d50] Final|Native|Public|HasOutParms|BlueprintCallable 
	{
		typedef void (*FuncPtr)(FNavAvoidanceMask&);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void SetAvoidanceGroup(int32_t GroupFlags) // [0x1be1cc0] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(int32_t);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void SetAvoidanceEnabled(bool bEnable) // [0x1be1c30] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void ServerUpdateState(float InSteeringInput, float InThrottleInput, float InBrakeInput, float InHandbrakeInput, int32_t CurrentGear) // [0x1be1a40] Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	{
	...
	bool GetUseAutoGears() // [0x1be19b0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	int32_t GetTargetGear() // [0x1be1980] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	float GetForwardSpeed() // [0x1be18c0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	float GetEngineRotationSpeed() // [0x1be1890] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef float (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	float GetEngineMaxRotationSpeed() // [0x1be1860] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef float (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	int32_t GetCurrentGear() // [0x1be1830] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef int32_t (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
...
public:
	...
	void SetSteerAngle(float SteerAngle, int32_t WheelIndex) // [0x1be23f0] Final|Native|Public|BlueprintCallable 
	{
	...
	void SetDriveTorque(float DriveTorque, int32_t WheelIndex) // [0x1be1f30] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(float, int32_t);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
	...
	void SetBrakeTorque(float BrakeTorque, int32_t WheelIndex) // [0x1be1e60] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(float, int32_t);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[2]);
...
public:
	...
	AWheeledVehicle* GetVehicle() // [0x1be19e0] Final|Native|Public|BlueprintCallable 
	{
...
public:
	...
	bool IsInAir() // [0x1be1a10] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef bool (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
	...
	float GetSuspensionOffset() // [0x1be1950] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef float (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
	...
	float GetSteerAngle() // [0x1be1920] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef float (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[2]);
	...
	float GetRotationAngle() // [0x1be18f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef float (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[3]);
...
{ 
public:
	class USkeletalMeshComponent*                      Mesh;                                                       // 0x0288   (0x0008)  
	class UWheeledVehicleMovementComponent*            VehicleMovement;                                            // 0x0290   (0x0008)  
};
...
static_assert(sizeof(AWheeledVehicle) == 0x0298); // 664 bytes (0x000288 - 0x000298)
...
static_assert(offsetof(AWheeledVehicle, Mesh) == 0x0288);
static_assert(offsetof(AWheeledVehicle, VehicleMovement) == 0x0290);
