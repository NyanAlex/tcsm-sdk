...
{ 
public:
	SDK_UNDEFINED(80,685) /* TSet<FName> */            __um(Layers);                                               // 0x0030   (0x0050)  
	SDK_UNDEFINED(80,686) /* TSet<FName> */            __um(Tags);                                                 // 0x0080   (0x0050)  
};
...
{ 
public:
	TEnumAsByte<EComponentMobility>                    Mobility;                                                   // 0x0228   (0x0001)  
	EDatasmithAreaLightActorType                       LightType;                                                  // 0x0229   (0x0001)  
	EDatasmithAreaLightActorShape                      LightShape;                                                 // 0x022A   (0x0001)  
	unsigned char                                      UnknownData00_6[0x1];                                       // 0x022B   (0x0001)  MISSED
	FVector2D                                          Dimensions;                                                 // 0x022C   (0x0008)  
	float                                              Intensity;                                                  // 0x0234   (0x0004)  
	ELightUnits                                        IntensityUnits;                                             // 0x0238   (0x0001)  
	unsigned char                                      UnknownData01_6[0x3];                                       // 0x0239   (0x0003)  MISSED
	FLinearColor                                       Color;                                                      // 0x023C   (0x0010)  
	float                                              Temperature;                                                // 0x024C   (0x0004)  
	class UTextureLightProfile*                        IESTexture;                                                 // 0x0250   (0x0008)  
...
public:
	...
	FString GetDatasmithUserDataValueForKey(UObject* Object, FName Key) // [0x19a6940] Final|Native|Static|Public|BlueprintCallable 
	{
	...
	// void GetDatasmithUserDataKeysAndValuesForValue(UObject* Object, FString StringToMatch, TArray<FName>& OutKeys, TArray<FString>& OutValues); // [0x19a6780] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserData
	UDatasmithAssetUserData* GetDatasmithUserData(UObject* Object) // [0x19a66f0] Final|Native|Static|Public|BlueprintCallable 
	{
...
{ 
public:
	TArray<class ULevelSequence*>                      ImportedSequences;                                          // 0x0228   (0x0010)  


	/// Functions
	// Function /Script/DatasmithContent.DatasmithImportedSequencesActor.PlayLevelSequence
	void PlayLevelSequence(ULevelSequence* SequenceToPlay) // [0x19a6a50] Final|Native|Public|BlueprintCallable 
	{
...
public:
	...
	SDK_UNDEFINED(80,687) /* TMap<FName, TWeakObjectPtr<UTexture*>> */ __um(TextureParameterValues);               // 0x00F8   (0x0050)  
...
{ 
public:
	class UDatasmithScene*                             Scene;                                                      // 0x0228   (0x0008)  
	SDK_UNDEFINED(80,688) /* TMap<FName, TWeakObjectPtr<AActor*>> */ __um(RelatedActors);                          // 0x0230   (0x0050)  
};
...
public:
	...
	SDK_UNDEFINED(80,689) /* TSet<FName> */            __um(Tags);                                                 // 0x0098   (0x0050)  
...
static_assert(sizeof(ADatasmithAreaLightActor) == 0x0280); // 640 bytes (0x000228 - 0x000280)
...
static_assert(sizeof(ADatasmithImportedSequencesActor) == 0x0238); // 568 bytes (0x000228 - 0x000238)
...
static_assert(sizeof(ADatasmithSceneActor) == 0x0280); // 640 bytes (0x000228 - 0x000280)
...
static_assert(offsetof(ADatasmithAreaLightActor, Mobility) == 0x0228);
static_assert(offsetof(ADatasmithAreaLightActor, LightType) == 0x0229);
static_assert(offsetof(ADatasmithAreaLightActor, LightShape) == 0x022A);
static_assert(offsetof(ADatasmithAreaLightActor, Dimensions) == 0x022C);
static_assert(offsetof(ADatasmithAreaLightActor, IntensityUnits) == 0x0238);
static_assert(offsetof(ADatasmithAreaLightActor, Color) == 0x023C);
static_assert(offsetof(ADatasmithAreaLightActor, IESTexture) == 0x0250);
static_assert(offsetof(ADatasmithAreaLightActor, Rotation) == 0x0260);
...
static_assert(offsetof(ADatasmithImportedSequencesActor, ImportedSequences) == 0x0228);
...
static_assert(offsetof(ADatasmithSceneActor, Scene) == 0x0228);
