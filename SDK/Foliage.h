...
/// Size: 0x06D0 (1744 bytes) (0x000698 - 0x0006D0) align 16 MaxSize: 0x06D0
class UFoliageInstancedStaticMeshComponent : public UHierarchicalInstancedStaticMeshComponent
{ 
public:
	SDK_UNDEFINED(16,702) /* FMulticastInlineDelegate */ __um(OnInstanceTakePointDamage);                          // 0x0698   (0x0010)  
	SDK_UNDEFINED(16,703) /* FMulticastInlineDelegate */ __um(OnInstanceTakeRadialDamage);                         // 0x06A8   (0x0010)  
	FGuid                                              GenerationGuid;                                             // 0x06B8   (0x0010)  
...
public:
	...
	int32_t FoliageOverlappingSphereCount(UObject* WorldContextObject, UStaticMesh* StaticMesh, FVector CenterPosition, float Radius) // [0x3405450] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	{
	...
	int32_t FoliageOverlappingBoxCount(UObject* WorldContextObject, UStaticMesh* StaticMesh, FBox Box) // [0x3405310] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	{
...
public:
	...
	bool                                               bUseGrassDensityScaling : 1;                                // 0x0396:0 (0x0001)  
	bool                                               bUseFlowerDensityScaling : 1;                               // 0x0396:1 (0x0001)  
	bool                                               bScalableDynamicShadows : 1;                                // 0x0396:2 (0x0001)  
	bool                                               bEnableDiscardOnLoad : 1;                                   // 0x0396:3 (0x0001)  
...
/// Size: 0x0298 (664 bytes) (0x000238 - 0x000298) align 8 MaxSize: 0x0298
...
public:
	...
	unsigned char                                      UnknownData00_7[0x4];                                       // 0x0294   (0x0004)  MISSED


	/// Functions
	// Function /Script/Foliage.InteractiveFoliageActor.CapsuleTouched
	void CapsuleTouched(UPrimitiveComponent* OverlappedComp, AActor* Other, UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex) // [0x34051b0] Final|Native|Protected 
	{
		typedef void (*FuncPtr)(UPrimitiveComponent*, AActor*, UPrimitiveComponent*, int32_t);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
		func(OverlappedComp, Other, OtherComp, OtherBodyIndex);
	}
};
...
{ 
public:
	class AProceduralFoliageVolume*                    ProceduralFoliageVolume;                                    // 0x0260   (0x0008)  
};
...
public:
	...
	void Simulate(int32_t NumSteps) // [0x34055b0] Final|Native|Public|BlueprintCallable 
	{
...
{ 
public:
	class UProceduralFoliageComponent*                 ProceduralComponent;                                        // 0x0260   (0x0008)  
};

#pragma pack(pop)


static_assert(sizeof(UFoliageInstancedStaticMeshComponent) == 0x06D0); // 1744 bytes (0x000698 - 0x0006D0)
...
static_assert(sizeof(AInstancedFoliageActor) == 0x0278); // 632 bytes (0x000228 - 0x000278)
static_assert(sizeof(AInteractiveFoliageActor) == 0x0298); // 664 bytes (0x000238 - 0x000298)
static_assert(sizeof(UInteractiveFoliageComponent) == 0x0500); // 1280 bytes (0x0004F8 - 0x000500)
static_assert(sizeof(AProceduralFoliageBlockingVolume) == 0x0268); // 616 bytes (0x000260 - 0x000268)
...
static_assert(sizeof(AProceduralFoliageVolume) == 0x0268); // 616 bytes (0x000260 - 0x000268)
static_assert(offsetof(UFoliageInstancedStaticMeshComponent, GenerationGuid) == 0x06B8);
...
static_assert(offsetof(AInteractiveFoliageActor, CapsuleComponent) == 0x0238);
static_assert(offsetof(AInteractiveFoliageActor, TouchingActorEntryPosition) == 0x0240);
static_assert(offsetof(AInteractiveFoliageActor, FoliageVelocity) == 0x024C);
static_assert(offsetof(AInteractiveFoliageActor, FoliageForce) == 0x0258);
static_assert(offsetof(AInteractiveFoliageActor, FoliagePosition) == 0x0264);
static_assert(offsetof(AProceduralFoliageBlockingVolume, ProceduralFoliageVolume) == 0x0260);
...
static_assert(offsetof(AProceduralFoliageVolume, ProceduralComponent) == 0x0260);
